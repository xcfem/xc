...
\indent {\em  Vector operator+(const Vector \&V);}
\indent {\em  Vector operator-(const Vector \&V);}
\indent {\em  double operator { }\f$\hat{ }\f$(const Vector \&V) const;   }
\indent {\em Vector operator/(const Matrix \&M) const; }
\indent {\em friend OPS_Stream \&operator\f$<<\f$(OPS_Stream \&s, const
//! Vector \&V);} 
\indent {\em friend istream \&operator\f$>>\f$(istream \&s, const
//! Vector \&V);} 


\noindent {\bf Constructors}
\indent {\em Vector();}
//! To construct a Vector of order \f$0\f$.
...
\indent {\em virtual~ \f$\tilde{}\f$Vector();} 
...
{\em friend OPS_Stream \&operator\f$<<\f$(OPS_Stream \&s, const Vector \&V);}
...
{\em friend istream \&operator\f$>>\f$(istream \&s, const Vector \&V);}
