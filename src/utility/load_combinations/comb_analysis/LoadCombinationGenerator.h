...
class LoadCombinationGenerator: public CommandEntity
  ...
  public:
    ...
    ActionDesignValues &insert(const std::string &,const std::string &,const Action &,const std::string &combination_factors_name="",const std::string &partial_safety_factors_name="");
    void genera(void);
