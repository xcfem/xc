	...
	noroom, logical *err)
{
    ...
    extern /* Subroutine */ int d2node_(integer *, real *, real *, integer *, 
	    integer *), mesage_(char *, ftnlen), addkxl_(integer *, integer *,
...
/*  MAKE THE NEW ELEMENT */
	...
	*i__ = *n2;
	...
	mesage_("PROBLEM HANDLING CONNECTION IN CONNOD", (ftnlen)37);
	mesage_("CONNECTION DOES NOT FORM A SIMPLE CORNER", (ftnlen)40);
	*err = TRUE_;
	goto L100;
    }
