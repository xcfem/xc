/* keep3.f -- translated by f2c (version 20160102).
...
/* Subroutine */ int keep3_(integer *itest, integer *ltest, integer *nbegin, 
	integer *nend)
{
...
/* *********************************************************************** */
/*  SUBROTINE KEEP3 = GETS AN ACCEPTABLE SIDE FOR FILLING TO KEEP A */
/*                    TRIANGLE VALID */
/* *********************************************************************** */
