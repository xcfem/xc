...
/* Subroutine */ int add2nd_(integer *mxnd, integer *mln, xc_float *xn, xc_float *yn, 
	integer *lxk, integer *kxl, integer *nxl, integer *lxn, xc_float *bnsize, 
	integer *lnodes, xc_float *x1, xc_float *y1, xc_float *x2, xc_float *y2, xc_float *dist1, 
	xc_float *dist2, integer *nnn, integer *lll, integer *kkk, integer *n1, 
	integer *n2, integer *nloop, logical *sizeit, logical *err, logical *
	noroom, xc_float *xnold, xc_float *ynold, integer *nxkold, integer *linkeg, 
	integer *listeg, xc_float *bmesur, integer *mlink, integer *npnold, 
	integer *npeold, integer *nnxk, xc_float *rexmin, xc_float *
	rexmax, xc_float *reymin, xc_float *reymax, integer *idivis, xc_float *sizmin, 
	xc_float *emax, xc_float *emin)
{
