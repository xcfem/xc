...
/* L100: */
    ...
    mesage_("** PROBLEMS IN SETN02 FINDING NNEW1 **", (ftnlen)38);
    return 0;
L110:
...
/* L120: */
    ...
    mesage_("** PROBLEMS IN SETN02 FINDING NNEW2 **", (ftnlen)38);
    return 0;
L130:
...
/*  COUNTER-CLOCKWISE ORDER */
	...
	if (lxk[i__ + (k1 << 2)] == *line) {
		...
		*n2 = nnew1;
		...
		mesage_("** PROBLEMS IN SETN02 FINDING N0 AND N2 **", (ftnlen)
			42);
	    }
	    goto L150;
	}
/* L140: */
    ...
    mesage_("** PROBLEMS IN SETN02 FINDING LINE AGAIN **", (ftnlen)43);
L150:
    return 0;
} /* setn02_ */
