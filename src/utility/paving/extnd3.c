...
/* Subroutine */ int extnd3_(integer *mxnd, real *xn, real *yn, real *angle, 
	integer *n1, integer *n2, integer *n3, real *x, real *y, real *dist)
{
    ...
    /* Local variables */
    static real ang, ang1, ang2, ang3, cang, dist1, dist2, adist;
...
/* *********************************************************************** */
    ...
    cang = *angle / (float)3.;
    ang1 = ang - cang;
    ang2 = ang - *angle * (float).5;
    ang3 = ang - cang * (float)2.;
/* Computing 2nd power */
    r__1 = yn[*n2] - yn[*n1];
/* Computing 2nd power */
    r__2 = xn[*n2] - xn[*n1];
