	...
	kkkadd)
{
    ...
    extern /* Subroutine */ int mesage_(char *, ftnlen), undelm_(integer *, 
...
/* L100: */
	    ...
	    mesage_("** PROBLEMS IN LONGEL FINDING L1 **", (ftnlen)35);
	    *err = TRUE_;
	    goto L250;
L110:
	    for (i__ = 1; i__ <= 4; ++i__) {
...
/* L120: */
	    ...
	    mesage_("** PROBLEMS IN LONGEL FINDING L2 **", (ftnlen)35);
	    *err = TRUE_;
	    goto L250;
L130:
	    for (i__ = 1; i__ <= 4; ++i__) {
...
/* L140: */
	    ...
	    mesage_("** PROBLEMS IN LONGEL FINDING L4/L3 **", (ftnlen)38);
	    *err = TRUE_;
	    goto L250;
L150:
	    for (i__ = 1; i__ <= 4; ++i__) {
...
/* L160: */
	    ...
	    mesage_("** PROBLEMS IN LONGEL FINDING L3/L4 **", (ftnlen)38);
	    *err = TRUE_;
	    goto L250;
L170:
/*  NOW FIND KELEM2 */
...
/* L180: */
		...
		mesage_("** PROBLEMS IN LONGEL FINDING NODE3/D11 **", (ftnlen)
			42);
		*err = TRUE_;
		goto L250;
L190:
...
/* L220: */
	    ...
	    mesage_("** PROBLEMS IN LONGEL FINDING L5 **", (ftnlen)35);
	    *err = TRUE_;
	    goto L250;
L230:
