...
class_<PrincipalAxes2D>("PrincipalAxes2D",init<const Pos2d &,const GEOM_FT &,const GEOM_FT &,const GEOM_FT &>())
  ...
  .def("getAxis1VDir", &PrincipalAxes2D::getAxis1VDir,"Returns the direction vector of the first principal axis.")
  .def("getAxis2VDir", &PrincipalAxes2D::getAxis2VDir,"Returns the direction vector of the second principal axis.")
 ;
...
class_<PrincipalAxes3D>("PrincipalAxes3D",init<const Pos3d &, const GEOM_FT &, const GEOM_FT &, const GEOM_FT &, const GEOM_FT &, const GEOM_FT &, const GEOM_FT &>())
  ...
  .def("getAxis", &PrincipalAxes3D::getAxis,"Returns the reference system corresponding to principal axes.")
  .def("getAxis1VDir", &PrincipalAxes3D::getAxis1VDir,"Returns the direction vector of the first principal axis.")
  .def("getAxis2VDir", &PrincipalAxes3D::getAxis2VDir,"Returns the direction vector of the second principal axis.")
  .def("getAxis3VDir", &PrincipalAxes3D::getAxis3VDir,"Returns the direction vector of the third principal axis.")
 ;
