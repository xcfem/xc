...
class_<FrenetTrihedron, bases<ProtoGeom> >("FrenetTrihedron")
  ...
  .def("getTangentVectorAtVertices", &FrenetTrihedron::getTangentVectorAtVerticesPy, "Return a Python list containing the tangent vectors at each of the polyline vertices.")
  .def("getNormalVectorAtVertices", &FrenetTrihedron::getNormalVectorAtVerticesPy, "Return a Python list containing the normal vectors at each of the polyline vertices.")
  .def("getBinormalVectorAtVertices", &FrenetTrihedron::getBinormalVectorAtVerticesPy, "Return a Python list containing the binormal vectors at each of the polyline vertices.")
