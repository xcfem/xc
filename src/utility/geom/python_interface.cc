...
BOOST_PYTHON_MODULE(geom)
  {
    ...
    class_<GeomObj, bases<ProtoGeom>, boost::noncopyable >("GeomObj", no_init)
      ...
      .def("getVolume", pure_virtual(&GeomObj::getVolume), "return the object volume.")
      .def("getDimension", pure_virtual(&GeomObj::Dimension), "return the object dimension.")
    ...
    class_<GeomObj2d, bases<GeomObj>, boost::noncopyable >("GeomObj2d", no_init)
      ...
      .def("getWx", &GeomObj2d::Wx, "Return the section modulus with respect to its x-x axis.")
      .def("getIy", pure_virtual(&GeomObj2d::Iy))
      .def("getWy", &GeomObj2d::Wy, "Return the section modulus with respect to its y-y axis.")
      .def("getIz", &GeomObj2d::Iz)
      .def("getPxy", pure_virtual(&GeomObj2d::Pxy))
      .def("getPrincipalAxes", &GeomObj2d::Inertia, "Return the principal axes of inertia of the object.")
    ...
    class_<GeomObj3d, bases<GeomObj>, boost::noncopyable >("GeomObj3d", no_init)
      ...
      .def("getPrincipalAxes", &GeomObj3d::Inertia, "Return the principal axes of inertia of the object.")
