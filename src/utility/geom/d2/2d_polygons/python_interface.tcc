...
class_<PolygonalSurface2d, bases<Surface2d>, boost::noncopyable >("PolygonalSurface2d", no_init)
  ...
  .def("getVertices",&PolygonalSurface2d::getVertexList,"Return the vertices list.")
  .def("getVertexList",&PolygonalSurface2d::getVertexListPy,"Return a Python list containing the positions of the polygon vertices.")
  .def("getEdgeList",&PolygonalSurface2d::getEdgeListPy,"Return a Python list containing the edges of the polygon.")
