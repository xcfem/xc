...
class_<Pos2d, bases<ProtoGeom> >("Pos2d")
  ...
  .def(init<Pos2d>())
  .def("__eq__", &Pos2d::operator==)
  .def("__ne__", &Pos2d::operator!=)
  .def("__len__",&Pos2d::dimension)
  ...
  .def("getBufferPolygon", &Pos2d::getBufferPolygon, "Return a buffer polygon around the point.")
...
class_<Pos2dArray, bases<m_pos2d> >("MatrixPos2d")
  ...
  .def("getQuad",&Pos2dArray::GetQuad,"Return the (i,j) quad.")
  .def("getAreaQuad",&Pos2dArray::GetAreaQuad, "Return the area of the (i,j) quad.")
  .def("getQuadAreas",&Pos2dArray::getQuadAreasPy, "Return the centroids of the grid quads.")
  .def("getQuadCentroid",&Pos2dArray::getQuadCentroid, "Return the centroid of the (i,j) quad.")
  .def("getQuadCentroids",&Pos2dArray::getQuadCentroidsPy, "Return the centroids of the grid quads.")
...
class_<Vector2d, bases<ProtoGeom> >("Vector2d")
  ...
  .def("__len__",&Vector2d::dimension)
  .def("__getitem__", &Vector2d::at, return_value_policy<return_by_value>())
  .def("__iter__", boost::python::iterator<Vector2d, boost::python::return_value_policy<boost::python::return_by_value>>{})
  .def("getDimension", &Vector2d::dimension,"return the dimension of the object.")
  .def("__len__",&Vector2d::dimension,"return the dimension of the vector.")
  .def("normalize", &Vector2d::Normalize, "divides the vector by its modulus.")
  .def("normalized", &Vector2d::getNormalized, "Return the normalized vector (vector with norm 1).")
  .def("getAngle", &Vector2d::getAngle, "Return the angle with the vector argument (order is important)")
  .def("getSignedAngle", &Vector2d::getSignedAngle, "Return the signed angle with the vector argument (order is important)")
...
class_<Dir3d, boost::noncopyable>("Dir3d", no_init)
  ...
  .def("__eq__", &Dir3d::operator==)
  .def("__ne__", &Dir3d::operator!=)
  .def("getDimension", &Dir3d::dimension,"return the dimension of the object.")
  .def(self_ns::str(self_ns::self))
  .def(self_ns::repr(self_ns::self))
  ;
...
class_<Vector3d, bases<ProtoGeom> >("Vector3d")
  ...
  .def("__len__",&Vector3d::dimension)
  .def("__getitem__", &Vector3d::at, return_value_policy<return_by_value>())
  .def("__iter__", boost::python::iterator<Vector3d, boost::python::return_value_policy<boost::python::return_by_value>>{})
  .def("normalize", &Vector3d::Normalize, "divides the vector by its modulus.")
  .def("getDimension", &Vector3d::dimension,"return the dimension of the object.")
  .def("__len__",&Vector3d::dimension,"return the dimension of the vector.")
  ...
  .def("getSignedAngle", &Vector3d::getSignedAngle, "Return the signed angle with the vector argument (order is important)")
  ...
  .def("getNormalVector", &Vector3d::Normal, "Return a vector normal to this one.")
  .def("perpendicular", &Vector3d::Perpendicular)
  .def("cross", &Vector3d::getCross)
  .def("dot", dotVector3d,"Returns scalar product.")
  .def("getModulus", &Vector3d::GetModulus, "Return the modulus of the vector.")
  .def("getModulus2", &Vector3d::GetModulus2, "Return the squared modulus of the vector.")
  .def("getList", &Vector3d::getPyList, "Return the vector components in a Python list.")
  .def(-self) // __neg__ (unary minus)
  .def(self + Vector3d())
  .def(self - Vector3d())
  .def(self * double())
...
class_<Pos3d, bases<ProtoGeom> >("Pos3d")
  .def(init<double, double, double>())
  .def(init<Pos3d>())
  .def("__eq__", &Pos3d::operator==)
  .def("__ne__", &Pos3d::operator!=)
  .def("__len__",&Pos3d::dimension)
  ...
  .def("getDimension", &Pos3d::dimension,"return the dimension of the object.")
  .def(self + Vector3d())
  .def(self - Vector3d())
  .def(self - Pos3d())
  .def(self_ns::str(self_ns::self))
...
class_<SlidingVector2d, bases<Vector2d> >("SlidingVector2d")
  ...
  .def("__eq__", &SlidingVector2d::operator==)
  .def("__ne__", &SlidingVector2d::operator!=)
...
class_<SlidingVector3d, bases<Vector3d> >("SlidingVector3d")
  ...
  .def("__eq__", &SlidingVector3d::operator==)
  .def("__ne__", &SlidingVector3d::operator!=)
