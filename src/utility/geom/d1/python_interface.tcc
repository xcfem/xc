...
class_<Line2d, bases<Linear2d> >("Line2d")
  ...
  .def("getPos2dProj",Pos2dProj,"TO DEPRECATE return the projection of a point onto the line.")
  .def("getVector2dProj",Vector2dProj,"TO DEPRECATE return the projection of a vector onto the line.")
  .def("getProjection",Pos2dProj,"Return the projection of a point onto the line.")
  .def("getProjection",Vector2dProj,"Return the projection of a vector onto the line.")
  .def("getPoint",&Line2d::getPointAtLength,"return a point on the line.")
...
class_<Ray2d, bases<Linear2d> >("Ray2d")
  ...
  .def("getPoint",&Ray2d::getPointAtLength,"return a point on the line.")
...
class_<Segment2d, bases<Linear2d> >("Segment2d")
  ...
  .def("getPoint",&Segment2d::getPointAtLength,"return a point on the segment.")
...
class_<Line3d, bases<Linear3d> >("Line3d")
  ...
  .def("getVector3dProj", Vector3dProj,"TO DEPRECATE return the projection of a vector onto the line.")
  .def("getProjection", Vector3dProj,"return the projection of a vector onto the line.")
  .def("getVDir",&Line3d::VDir,"return the line direction vector.")
  .def("getPoint",&Line3d::getPointAtLength,"return a point on the line.")
...
class_<Ray3d, bases<Linear3d> >("Ray3d")
  ...
  .def("getPoint",&Ray3d::getPointAtLength,"return a point on the line.")
  ;
...
class_<Segment3d, bases<Linear3d> >("Segment3d")
  ...
  .def("getPoint",&Segment3d::getPointAtLength,"return a point on the segment.")
...
//.def(init<Pos3dList>())
  ...
  .def("getCurvatureVectorAtVertices", &Polyline3d::getCurvatureVectorAtVerticesPy, "Return a Python list containing the normal vectors at each of the polyline vertices.")
