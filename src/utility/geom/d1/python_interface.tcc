...
class_<Polyline2d, bases<Linear2d, polyPos2d> >("Polyline2d")
  ...
  .def("getChunk", &Polyline2d::getChunk,"getChunk(point, sgn) returns the chunk of the polyline that goes from the begining to the argument point if sgn<0 or from the argument point to the polyline end if sgn>=0")
...
//.def(init<Pos3dList>())
  ...
  .def("getChunk", &Polyline3d::getChunk,"getChunk(point, sgn) returns the chunk of the polyline that goes from the begining to the argument point if sgn<0 or from the argument point to the polyline end if sgn>=0")  
