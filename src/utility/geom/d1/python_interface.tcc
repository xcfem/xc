...
class_<Polyline2d, bases<Linear2d, polyPos2d> >("Polyline2d")
 ...
 .def("getNearestSegment", &Polyline2d::getNearestLink, "Return the nearest segment to the given point.")
...
class_<PlanePolyline3d, bases<Linear3d> >("PlanePolyline3d")
  ...
  .def("getNearestSegment", &PlanePolyline3d::getNearestLink, "Return the nearest segment to the given point.")
