/* subpen.f -- translated by f2c (version 20160102).
...
/* Subroutine */ int subpen_(integer *nper, integer *newper, real *x, real *y,
	 integer *nid, real *xsub, real *ysub, integer *nidsub, integer *num, 
	integer *m1, integer *m2, integer *iadd, integer *itri, real *xcen, 
	real *ycen)
{
...
/* *********************************************************************** */
/*  SUBROUTINE SUBPEN = PUTS A PENTAGON SUBREGION'S PERIMETER INTO THE */
/*                      NPERIM ARRAYS */
/* *********************************************************************** */
