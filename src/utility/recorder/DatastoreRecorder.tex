...
\noindent {\bf Files}
\indent \#include \f$<\tilde{ }\f$/recorder/DatastoreRecorder.h\f$>\f$
...
//! commitState()} on an FE\_Datastore object when {\em commit() is
...
\indent // Destructor
\indent {\em \f$\tilde{ }\f$DatastoreRecorder();}
...
\indent {\em DatastoreRecorder(FE\_Datastore \&theDatastore);} 
//! Saves a pointer to the object \p theDatastore.

\noindent {\bf Destructor}
\indent {\em virtual~ \f$\tilde{}\f$DatastoreRecorder();} 
//! Does nothing.
