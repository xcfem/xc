...
// Revision: A
//
// Description: This file contains the class implementation for XC::AlgorithmIncrements
...
#include <utility/recorder/AlgorithmIncrements.h>
...
XC::AlgorithmIncrements::AlgorithmIncrements(EquiSolnAlgo *theEquiAlgo,
  ...
  :Recorder(RECORDER_TAGS_AlgorithmIncrements),
   numRecord(0), displayRecord(displayOnRecord), fileName(0)
{
...
XC::AlgorithmIncrements::~AlgorithmIncrements(void)
{
