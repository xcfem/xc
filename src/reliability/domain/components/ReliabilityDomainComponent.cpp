...
XC::ReliabilityDomainComponent::ReliabilityDomainComponent(int passedTag, int passedClassTag)
...
void
XC::ReliabilityDomainComponent::setReliabilityDomain(ReliabilityDomain *model)
{
    // sets the pointer 
...
XC::ReliabilityDomainComponent::getReliabilityDomain(void) const
{
