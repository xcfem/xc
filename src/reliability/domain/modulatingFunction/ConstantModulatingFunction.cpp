...
#include <reliability/domain/modulatingFunction/ConstantModulatingFunction.h>
#include <reliability/domain/modulatingFunction/ModulatingFunction.h>
#include <classTags.h>
#include <reliability/domain/filter/Filter.h>


XC::ConstantModulatingFunction::ConstantModulatingFunction(int tag,
												 Filter *theFilt,
												 double pamplitude)
...
double XC::ConstantModulatingFunction::getAmplitude(double time)
  { return amplitude; }

 XC::Filter *
XC::ConstantModulatingFunction::getFilter()
{
	return theFilter;
}
