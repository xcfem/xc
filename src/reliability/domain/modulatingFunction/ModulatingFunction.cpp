...
// $Source: /usr/local/cvs/OpenSees/SRC/reliability/domain/modulatingFunction/ModulatingFunction.cpp,v $
...
XC::ModulatingFunction::ModulatingFunction(int tag,int classtag)
