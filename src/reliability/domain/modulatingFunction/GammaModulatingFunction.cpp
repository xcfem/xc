...
XC::GammaModulatingFunction::GammaModulatingFunction(int tag,
												 Filter *theFilt,
												 double pa,
												 double pb,
												 double pc)
...
double
XC::GammaModulatingFunction::getAmplitude(double time)
{
	return ( a * pow(time,b) * exp(-c*time)  );
}

 XC::Filter *
XC::GammaModulatingFunction::getFilter()
{
	return theFilter;
}

double
XC::GammaModulatingFunction::getMaxAmplitude()
{
