...
//
//! In probability theory and statistics, the continuous uniform
//! distribution or rectangular distribution is a family of symmetric
//! probability distributions. The distribution describes an experiment
//! where there is an arbitrary outcome that lies between certain bounds.
