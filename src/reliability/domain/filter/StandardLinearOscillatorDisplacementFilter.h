...
#ifndef StandardLinearOscillatorDisplacementFilter_h
#define StandardLinearOscillatorDisplacementFilter_h
...
// 
//! @brief Standard linear oscillator displacement filter.
