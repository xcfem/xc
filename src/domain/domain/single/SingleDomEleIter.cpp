...
XC::SingleDomEleIter::SingleDomEleIter(TaggedObjectStorage *theStorage)
  :SingleDomTIter<ElementIter>(theStorage) {}


XC::Element *XC::SingleDomEleIter::operator()(void)
  { return XC::getIterPtr<XC::Element>(*this);  }
