...
// SingleDomMRMP_Iter(SingleDomain &theDomain):
//	constructor that takes the model, just the basic iter

XC::SingleDomMRMP_Iter::SingleDomMRMP_Iter(TaggedObjectStorage *theStorage)
  :SingleDomTIter<MRMP_ConstraintIter>(theStorage) {}

XC::MRMP_Constraint *XC::SingleDomMRMP_Iter::operator()(void)
  { return XC::getIterPtr<MRMP_Constraint>(*this);  }
