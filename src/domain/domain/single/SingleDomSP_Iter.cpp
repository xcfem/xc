...
XC::SingleDomSP_Iter::SingleDomSP_Iter(TaggedObjectStorage *theStorage)
  :SingleDomTIter<SP_ConstraintIter>(theStorage)
  {}

XC::SP_Constraint *XC::SingleDomSP_Iter::operator()(void)
  { return XC::getIterPtr<SP_Constraint>(*this);  }
