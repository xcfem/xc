...
XC::SingleDomMP_Iter::SingleDomMP_Iter(TaggedObjectStorage *theStorage)
  :SingleDomTIter<MP_ConstraintIter>(theStorage) {}

XC::MP_Constraint *XC::SingleDomMP_Iter::operator()(void)
  { return XC::getIterPtr<MP_Constraint>(*this);  }
