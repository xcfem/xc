...
\indent\indent {\em virtual~ \f$\tilde{}\f$PartitionedDomain();}
...
\indent\indent {\em virtual bool addSFreedom\_Constraint(SFreedom\_Constraint *theSPptr, bool
//! check = false);}
...
\indent\indent {\em virtual SFreedom\_Constraint *removeSFreedom\_Constraint(int
//! tag);} 
...
\indent {\em virtual~ \f$\tilde{}\f$PartitionedDomain();}
