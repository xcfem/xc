...
XC::PartitionedDomainSubIter::PartitionedDomainSubIter(TaggedObjectStorage *theStorage)
  :SingleDomTIter<SubdomainIter>(theStorage) {}

XC::Subdomain *XC::PartitionedDomainSubIter::operator()(void)
  { return XC::getIterPtr<Subdomain>(*this);  }
