...
class_<XC::Domain, bases<XC::ObjWithRecorders>, boost::noncopyable >("Domain", no_init)
  ...
  .def("removeAllLoadPatterns",&XC::Domain::removeAllLoadPatterns,"removeAllLoadPatterns(): remove all the load patterns from domain.")
  .def("removeAllLoadCombinations",&XC::Domain::removeAllLoadCombinations,"removeAllLoadCombinations(): remove all the load combinations from domain.")
  .def("removeAllLoadsAndCombinations",&XC::Domain::removeAllLoadsAndCombinations,"removeAllLoadsAndCombinations(): remove all the load patterns and load combinations from domain.")
  ...
  .def("getEffectiveModalMass",&XC::Domain::getEffectiveModalMass,"getEffectiveModalMass(mode): return the effective modal mass corresponding to the given mode.")
  .def("getEffectiveModalMasses",&XC::Domain::getEffectiveModalMasses,"getEffectiveModalMasses(): return the computed effective modal masses corresponding to each of the computed eigenmodes.")
  .def("getTotalEffectiveModalMass",&XC::Domain::getTotalEffectiveModalMass,"getTotalEffectiveModalMass(): return the sum of the effective modal masses corresponding to the computed eigenmodes.")
  .add_property("totalMass", &XC::Domain::getTotalMass, "Return the total mass matrix.")
  .def("getTotalMassComponent", &XC::Domain::getTotalMassComponent,"Return the total mass matrix component for the given DOF.")
