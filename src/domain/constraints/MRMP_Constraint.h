...
#ifndef MRMP_Constraint_h
#define MRMP_Constraint_h

// File: ~/domain/constraints/MRMP_Constraint.h
//
// Written: fmk 
// Created: 11/96
// Revision: A
//
// Purpose: This file contains the class definition for MRMP_Constraint.
// MRMP_Constraint is a class which stores the information for a multiple
...
// The MRMP_Constraint class assumes time invariant constraints, i.e. the
...
class MRMP_Constraint: public MP_ConstraintBase
  {
  protected:
  ...
  public:
    // constructors        
    MRMP_Constraint(int tag , int classTag ); // Arash
    MRMP_Constraint(int tag); // LCPT

    MRMP_Constraint(int tag,const ID &, int nodeConstr, int classTag);    

    MRMP_Constraint(int tag,const ID &, int nodeConstr, const ID &constrainedDOF);    
    MRMP_Constraint(int tag,const ID &, int nodeConstr, const ID &constrainedDOF,int classTag);    

    MRMP_Constraint(int tag,const ID &, int nodeConstr, const Matrix &, const ID &constrainedDOF);
    MRMP_Constraint(int tag,const Element &, const Node &, const ID &);
