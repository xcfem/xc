...
XC::ShellMITC4Base::ShellMITC4Base(int classTag, const ShellCrdTransf3dBase *crdTransf)
  : QuadBase4N<SectionFDPhysicalProperties>(0,classTag,SectionFDPhysicalProperties(1,nullptr)), Ktt(0.0),theCoordTransf(nullptr),
...
XC::ShellMITC4Base::ShellMITC4Base(int tag, int classTag,const SectionForceDeformation *ptr_mat, const ShellCrdTransf3dBase *crdTransf)
  : QuadBase4N<SectionFDPhysicalProperties>(tag,classTag,SectionFDPhysicalProperties(1,ptr_mat)), Ktt(0.0), theCoordTransf(nullptr),
    p0(), inicDisp(4,Vector()) 
  { alloc(crdTransf); }
