...
bool XC::GaussQuadRule1d01::dataSet = false;

double XC::GaussQuadRule1d01::ptsArray[maxOrder*(maxOrder+1)/2];
double XC::GaussQuadRule1d01::wtsArray[maxOrder*(maxOrder+1)/2];

 XC::Matrix XC::GaussQuadRule1d01::pts1 ( ptsArray,     1,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts2 (&ptsArray[1],  2,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts3 (&ptsArray[3],  3,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts4 (&ptsArray[6],  4,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts5 (&ptsArray[10], 5,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts6 (&ptsArray[15], 6,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts7 (&ptsArray[21], 7,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts8 (&ptsArray[28], 8,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts9 (&ptsArray[36], 9,  1);
 XC::Matrix XC::GaussQuadRule1d01::pts10(&ptsArray[45], 10, 1);

 XC::Vector XC::GaussQuadRule1d01::wts1 ( wtsArray,     1);
 XC::Vector XC::GaussQuadRule1d01::wts2 (&wtsArray[1],  2);
 XC::Vector XC::GaussQuadRule1d01::wts3 (&wtsArray[3],  3);
 XC::Vector XC::GaussQuadRule1d01::wts4 (&wtsArray[6],  4);
 XC::Vector XC::GaussQuadRule1d01::wts5 (&wtsArray[10], 5);
 XC::Vector XC::GaussQuadRule1d01::wts6 (&wtsArray[15], 6);
 XC::Vector XC::GaussQuadRule1d01::wts7 (&wtsArray[21], 7);
 XC::Vector XC::GaussQuadRule1d01::wts8 (&wtsArray[28], 8);
 XC::Vector XC::GaussQuadRule1d01::wts9 (&wtsArray[36], 9);
 XC::Vector XC::GaussQuadRule1d01::wts10(&wtsArray[45], 10);

XC::GaussQuadRule1d01::GaussQuadRule1d01()
...
int XC::GaussQuadRule1d01::setOrder(int quadOrder)
{
  if (quadOrder < 1 || quadOrder > maxOrder) {
    std::cerr << "XC::GaussQuadRule1d01::setOrder() -- Invalid quadrature order, " << quadOrder << std::endl;
    return -1;
  }
  ...
  default:
    std::cerr <<"XC::GaussQuadRule1d01::setOrder() -- Invalid quadrature order " << order << std::endl;
    return -1;
    break;
  }    
...
int XC::GaussQuadRule1d01::getOrder (void) const
{
  return order;
}

int XC::GaussQuadRule1d01::getNumIntegrPoints (void) const
{
  return order;
}
...
const XC::Vector & 
XC::GaussQuadRule1d01::getIntegrPointWeights (int quadOrder)
{
  if (order != quadOrder)
    this->setOrder(quadOrder);
