...
constructs an empty Truss element. The recvSelf() method must be
...
The Truss element returns the result of invoking commitState()
on it's associated UniaxialMaterial object. \\

{\em int revertToLastCommit(void);} \\
The Truss element returns the result of invoking revertToLastCommit()
on it's associated UniaxialMaterial object. \\

{\em int revertToStart(void);} \\
The Truss element returns the result of invoking revertToStart()
on it's associated UniaxialMaterial object. \\
