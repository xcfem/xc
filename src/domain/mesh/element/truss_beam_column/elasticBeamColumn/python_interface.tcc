...
class_<XC::ElasticBeam3d, bases<XC::ProtoBeam3d>, boost::noncopyable >("ElasticBeam3d", no_init)
  ...
  .add_property("getN", &XC::ElasticBeam3d::getN,"Average axial force (call 'calc_resisting_force' before).")
  ...
  .add_property("getVy", &XC::ElasticBeam3d::getVy, "Average Y shear force (call 'calc_resisting_force' before).")
  .add_property("getAVy1", &XC::ElasticBeam3d::getAVy1, "Y shear force wich acts at the back end of the element (call 'calc_resisting_force' before).")
  .add_property("getAVy2", &XC::ElasticBeam3d::getAVy2, "Y shear force wich acts at the front end of the element (call 'calc_resisting_force' before).")
  ...
  .add_property("getVz", &XC::ElasticBeam3d::getVz, "Average Z shear force (call 'calc_resisting_force' before).")
  .add_property("getAVz1", &XC::ElasticBeam3d::getAVz1, "Z shear force wich acts at the back end of the element (call 'calc_resisting_force' before).")
  .add_property("getAVz2", &XC::ElasticBeam3d::getAVz2, "Z shear force wich acts at the back end of the element (call 'calc_resisting_force' before).")
  ...
  .add_property("getT", &XC::ElasticBeam3d::getT,"Average torque at the element (call 'calc_resisting_force' before).")
