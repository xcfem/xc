...
class_<XC::ElasticBeam2d, bases<XC::ProtoBeam2d>, boost::noncopyable >("ElasticBeam2d", no_init)
  ...
  .add_property("getV", &XC::ElasticBeam2d::getV, "Mean shear force.")
  .add_property("getV1", &XC::ElasticBeam2d::getV1, "Shear at back end.")
  .add_property("getV2", &XC::ElasticBeam2d::getV2, "Shear at front end.")
  .add_property("getVy1", &XC::ElasticBeam2d::getV1, "Shear at back end.")
  .add_property("getVy2", &XC::ElasticBeam2d::getV2, "Shear at front end.") 
  .add_property("getN1", &XC::ElasticBeam2d::getN1, "Axial force at front end.")
  .add_property("getN2", &XC::ElasticBeam2d::getN2, "Axial force at back end.")
  .add_property("getM1", &XC::ElasticBeam2d::getM1, "Bending moment at back end.")
  .add_property("getM2", &XC::ElasticBeam2d::getM2, "Bending moment at front end.")
  .add_property("getMz1", &XC::ElasticBeam2d::getM1, "Bending moment at back end.")
  .add_property("getMz2", &XC::ElasticBeam2d::getM2, "Bending moment at front end.")
   ;
