...
void XC::HingeRadauBeamIntegration::getLocationsDeriv(int numSections,double L, double dLdh,double *dptsdh) const
  {
    double oneOverL = 1.0/L;
...
void XC::HingeRadauBeamIntegration::getWeightsDeriv(int numSections,double L, double dLdh,double *dwtsdh) const
{
  double oneOverL = 1.0/L;
