...
void XC::NewtonCotesBeamIntegration::getSectionLocations(int numSections, double L,double *xi) const
{
  switch(numSections) {
...
void XC::NewtonCotesBeamIntegration::getSectionWeights(int numSections, double L,double *wt) const
{
  switch (numSections) {
...
void
XC::NewtonCotesBeamIntegration::Print(std::ostream &s, int flag)
{
