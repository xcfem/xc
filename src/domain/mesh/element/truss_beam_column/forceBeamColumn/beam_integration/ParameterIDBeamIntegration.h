...
// $Source: /usr/local/cvs/OpenSees/SRC/element/forceBeamColumn/ParameterIDBeamIntegration.h,v $

#ifndef ParameterIDBeamIntegration_h
#define ParameterIDBeamIntegration_h
