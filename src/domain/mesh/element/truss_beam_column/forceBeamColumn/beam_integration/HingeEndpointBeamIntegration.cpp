...
void XC::HingeEndpointBeamIntegration::getSectionLocations(int numSections, double L,double *xi) const
  {
    ...
    const double alpha = 0.5-(lpI+lpJ)*halfOneOverL;
    const double beta  = 0.5+(lpI-lpJ)*halfOneOverL;
...
void XC::HingeEndpointBeamIntegration::getSectionWeights(int numSections, double L,double *wt) const
  {
