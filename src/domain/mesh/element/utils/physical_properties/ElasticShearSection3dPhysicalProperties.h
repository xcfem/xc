...
//----------------------------------------------------------------------------
//ElasticShearSection3dPhysicalProperties.h

#ifndef ElasticShearSection3dPhysicalProperties_h
#define ElasticShearSection3dPhysicalProperties_h
...
class ElasticShearSection3dPhysicalProperties: public ElasticSectionPhysicalProperties<ElasticShearSection3d>
  {
  public:
    inline ElasticShearSection3dPhysicalProperties(const size_t &nMat= 0)
      : ElasticSectionPhysicalProperties<ElasticShearSection3d>(nMat) {}
