...
//----------------------------------------------------------------------------
//ElasticShearSection2dPhysicalProperties.h

#ifndef ElasticShearSection2dPhysicalProperties_h
#define ElasticShearSection2dPhysicalProperties_h
...
class ElasticShearSection2dPhysicalProperties: public ElasticSectionPhysicalProperties<ElasticShearSection2d>
  {
  public:
    inline ElasticShearSection2dPhysicalProperties(const size_t &nMat= 0)
      : ElasticSectionPhysicalProperties<ElasticShearSection2d>(nMat) {}
