...
#include <set>
#include <string>
#include "coordinate_transformation_class_names.h"
...
bool XC::is_coordinate_transformation(const std::string &className)
  { return (crd_transf_class_names.find(className)!= crd_transf_class_names.end()); }
