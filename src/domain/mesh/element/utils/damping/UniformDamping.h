...
class UniformDamping: public UDampingBase
  {
  private:
  ...
  public:
    ...
    UniformDamping(int tag, double eta, double freq1, double freq2, double ta, double td, TimeSeries *fac, int nFilter, const Vector &alpha, const Vector &omegac);
    UniformDamping(void);
