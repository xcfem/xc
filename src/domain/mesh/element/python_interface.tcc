...
class_<XC::Element, XC::Element *,bases<XC::MeshComponent>, boost::noncopyable >("Element", no_init)
  ...
  .def("createInertiaLoad", make_function(&XC::Element::createInertiaLoad, return_internal_reference<>() ),"Create the inertia load for the given acceleration vector.")
...
class_<XC::Element1D, bases<ElementBase2N >, boost::noncopyable >("Element1D", no_init)
    ...
    .def("vector2dUniformLoadGlobal", make_function(&XC::Element1D::vector2dUniformLoadGlobal, return_internal_reference<>() ),"Element's load.")
    .def("vector2dUniformLoadLocal", make_function(&XC::Element1D::vector2dUniformLoadLocal, return_internal_reference<>() ),"Element's load.")
    .def("vector2dPartialUniformLoadGlobal", make_function(&XC::Element1D::vector2dPartialUniformLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector2dPartialUniformLoadLocal", make_function(&XC::Element1D::vector2dPartialUniformLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("vector2dPointByRelDistLoadGlobal", make_function(&XC::Element1D::vector2dPointByRelDistLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector2dPointByRelDistLoadLocal", make_function(&XC::Element1D::vector2dPointByRelDistLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("vector2dPointLoadGlobal", make_function(&XC::Element1D::vector2dPointLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector2dPointLoadLocal", make_function(&XC::Element1D::vector2dPointLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dUniformLoadGlobal", make_function(&XC::Element1D::vector3dUniformLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dUniformLoadLocal", make_function(&XC::Element1D::vector3dUniformLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dPointByRelDistLoadGlobal", make_function(&XC::Element1D::vector3dPointByRelDistLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dPointByRelDistLoadLocal", make_function(&XC::Element1D::vector3dPointByRelDistLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dPointLoadGlobal", make_function(&XC::Element1D::vector3dPointLoadGlobal, return_internal_reference<>() ), "Element's load.")
    .def("vector3dPointLoadLocal", make_function(&XC::Element1D::vector3dPointLoadLocal, return_internal_reference<>() ), "Element's load.")
    .def("strainLoad", make_function(&XC::Element1D::strainLoad, return_internal_reference<>() ), "Element's load.")
...
#include "special/frictionBearing/python_interface.tcc"
