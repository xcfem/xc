...
class_<XC::Node, bases<XC::MeshComponent>, boost::noncopyable >("Node", no_init)
  ...
  .add_property("getInitialPos2d", &XC::Node::getPosInicial2d,"Returns 2D initial position of node.")
  .add_property("getInitialPos3d", &XC::Node::getPosInicial3d,"Returns 3D initial position of node.")
  .add_property("getCurrentPos2d", &XC::Node::getPosFinal2d,"Returns 2D current position of node.")
  .add_property("getCurrentPos3d", &XC::Node::getPosFinal3d,"Returns 3D current position of node.")
  ...
  .def("addTributaria",&XC::Node::addTributaria)
  .def("resetTributaria",&XC::Node::resetTributaria)
  .def("getTributaria",make_function(&XC::Node::getTributaria,return_value_policy<copy_const_reference>()))
  .def("getAreaTributaria",make_function(&XC::Node::getTributaria,return_value_policy<copy_const_reference>()))
  .def("getLongTributaria",make_function(&XC::Node::getTributaria,return_value_policy<copy_const_reference>()))
  .def("getVolumenTributario",make_function(&XC::Node::getTributaria,return_value_policy<copy_const_reference>()))
