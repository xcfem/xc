...
\indent\indent {\em void Print(std::ostream \&s, int flag = 0);} \\
...
ndof,ndof}. This matrix is equal to that set in {\em setMass()
...
\p ndof and \p numCol. If not enough space is available for this
...
Sets the {\em \(row,col\)} entry of R to be equal to \p Value. If
...
remote machine to the Channel object \p theChannel. 
