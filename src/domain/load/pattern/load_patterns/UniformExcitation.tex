%File: ~/OOP/domain/load/pattern/UniformExcitation.tex
...
\indent // Destructor 
\indent {\em \f$\tilde{ }\f$UniformExcitation();}
\indent // Public Methods 
\indent {\em void applyLoad(double time);} 
\indent {\em void Print(std::ostream \&s, int flag);}
...
\indent {\em virtual~ \f$\tilde{}\f$UniformExcitation();} 
//! Does nothing.
