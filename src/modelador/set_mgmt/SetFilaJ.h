...
class SetFilaJ: public SetFila<TritrizPtrNod::var_ref_fila_j,TritrizPtrElem::var_ref_fila_j>
  ...
  public:
    ...
    SetFilaJ(EntMdlr &e,const size_t &f=1,const size_t &c=1,const std::string &nmb="",Modelador *mdlr= NULL);
    SetFilaJ(EntMdlr &e,const size_t &capa,const RangoIndice &,const size_t &c,const std::string &nmb="",Modelador *mdlr= NULL);  };
} //fin namespace XC
#endif
