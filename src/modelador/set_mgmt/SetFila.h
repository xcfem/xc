...
class SetFila: public SetEstruct
  ...
  public:
    SetFila(const FILATTZNOD &fn,const FILATTZELEM &fe,const std::string &nmb="",Modelador *mdlr= NULL);
...
template <class FILATTZNOD,class FILATTZELEM>
SetFila<FILATTZNOD,FILATTZELEM>::SetFila(const FILATTZNOD &fn,const FILATTZELEM &fe,const std::string &nmb,Modelador *mdlr)
  : SetEstruct(nmb,mdlr), fila_nod(fn), fila_elem(fe) {}
