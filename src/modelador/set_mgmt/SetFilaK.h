...
class SetFilaK: public SetFila<TritrizPtrNod::var_ref_fila_k,TritrizPtrElem::var_ref_fila_k>
  ...
  public:
    ...
    SetFilaK(EntMdlr &e,const size_t &f=1,const size_t &c=1,const std::string &nmb="",Modelador *mdlr= NULL);
    SetFilaK(EntMdlr &e,const size_t &capa,const size_t &f,const RangoIndice &,const std::string &nmb="",Modelador *mdlr=NULL);
  };
} //fin namespace XC
#endif
