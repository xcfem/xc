...
\indent\indent {\em virtual~\f$\tilde{}\f$Graph();}
...
//! removeEdgeFlag = true );}
\indent\indent {\em virtual void Print(std::ostream \&s, int flag = 0);}
\indent\indent {\em friend std::ostream \&operator<<(std::ostream \&s, const Graph 
\&G);}
...
\indent {\em virtual~\f$\tilde{}\f$Graph();}
...
\indent {\em friend std::ostream \&operator<<(std::ostream \&s, const Graph 
\&G);}
