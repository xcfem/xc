% File: ~/OOP/analysis/model/dof_grp/LagrangeDOF_Group.tex 
%What: "@(#) DOF_Group.tex, revA"

\noindent {\bf Files}
\indent \#include \f$<\tilde{ }\f$/analysis/dof\_grp/LagrangeDOF\_Group.h\f$>\f$
...
\indent // Constructors
\indent {\em LagrangeDOF\_Group(int tag, SFreedom\_Constraint \&spPtr);}
\indent {\em LagrangeDOF\_Group(int tag, MP\_Constraint \&mpPtr);}
\indent // Destructor
\indent {\em virtual~ \f$\tilde{}\f$LagrangeDOF\_Group();}
...
\indent {\em LagrangeDOF\_Group(int tag, SFreedom\_Constraint \&spPtr);}
//! Invokes the DOF\_Group constructor with {\em tag) and the integer \f$1\f$.
