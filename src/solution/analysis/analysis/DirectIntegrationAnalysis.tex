...
\&theIntegrator);}
\indent // Destructor
\indent {\em virtual~ \f$\tilde{}\f$DirectIntegrationAnalysis();}
...
\indent {\em void setDeltaT(double \f$\delta t\f$);} 
...
\p tStart, \p tFinish and \p thDomain are passed to the
...
\indent {\em \f$\tilde{ }\f$DirectIntegrationAnalysis();} 
...
{\em int setDeltaT(double \f$\delta t\f$);}
