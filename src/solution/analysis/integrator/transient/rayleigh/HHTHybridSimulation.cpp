...
//! @brief Constructor.
XC::HHTHybridSimulation::HHTHybridSimulation(SoluMethod *owr)
  : HHTBase(owr,INTEGRATOR_TAGS_HHTHybridSimulation,1.0),
    alphaF(1.0), theTest(nullptr), rFact(1.0) {}

//! @brief Constructor.
XC::HHTHybridSimulation::HHTHybridSimulation(SoluMethod *owr,double _rhoInf, ConvergenceTest &theT)
...
//! @brief Constructor.
XC::HHTHybridSimulation::HHTHybridSimulation(SoluMethod *owr,double _rhoInf, ConvergenceTest &theT,const RayleighDampingFactors &rF)
...
//! @brief Constructor.
XC::HHTHybridSimulation::HHTHybridSimulation(SoluMethod *owr,double _alphaI, double _alphaF, double _beta, double _gamma, ConvergenceTest &theT)
    : HHTBase(owr,INTEGRATOR_TAGS_HHTHybridSimulation,_alphaI,_beta,_gamma),
    alphaF(_alphaF), theTest(&theT), rFact(1.0) {}

//! @brief Constructor.
XC::HHTHybridSimulation::HHTHybridSimulation(SoluMethod *owr,double _alphaI, double _alphaF,
