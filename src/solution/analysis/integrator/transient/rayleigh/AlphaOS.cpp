...
//! @brief Constructor.
XC::AlphaOS::AlphaOS(SoluMethod *owr)
    : AlphaOSBase(owr,INTEGRATOR_TAGS_AlphaOS), alpha(1.0) {}

//! @brief Constructor.
XC::AlphaOS::AlphaOS(SoluMethod *owr,double _alpha)
  : AlphaOSBase(owr,INTEGRATOR_TAGS_AlphaOS,(2-_alpha)*(2-_alpha)*0.25,1.5-_alpha),
    alpha(_alpha) {}

//! @brief Constructor.
XC::AlphaOS::AlphaOS(SoluMethod *owr,double _alpha,const RayleighDampingFactors &rF)
  : AlphaOSBase(owr,INTEGRATOR_TAGS_AlphaOS,(2-_alpha)*(2-_alpha)*0.25,1.5-_alpha,rF), alpha(_alpha) {}

//! @brief Constructor.
XC::AlphaOS::AlphaOS(SoluMethod *owr,double _alpha, double _beta, double _gamma)
  : AlphaOSBase(owr,INTEGRATOR_TAGS_AlphaOS,_beta,_gamma), alpha(_alpha) {}

//! @brief Constructor.
XC::AlphaOS::AlphaOS(SoluMethod *owr,double _alpha, double _beta, double _gamma,const RayleighDampingFactors &rF)
