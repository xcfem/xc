...
//! @brief Constructor.
XC::CollocationHybridSimulation::CollocationHybridSimulation(SoluMethod *owr)
    : HHTBase(owr,INTEGRATOR_TAGS_CollocationHybridSimulation),
    theta(1.0), rFact(1.0), theTest(nullptr) {}

//! @brief Constructor.
XC::CollocationHybridSimulation::CollocationHybridSimulation(SoluMethod *owr,double _theta,ConvergenceTest &theT)
...
//! @brief Constructor.
XC::CollocationHybridSimulation::CollocationHybridSimulation(SoluMethod *owr,double _theta, ConvergenceTest &theT,const RayleighDampingFactors &rF)
...
//! @brief Constructor.
XC::CollocationHybridSimulation::CollocationHybridSimulation(SoluMethod *owr,double _theta,
