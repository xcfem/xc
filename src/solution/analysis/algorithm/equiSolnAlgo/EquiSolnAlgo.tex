...
\indent\indent {\em virtual~ \f$\tilde{}\f$EquiSolnAlgo();}
...
\indent\indent {\em virtual void Print(OPS\_Stream \&s, int flag = 0)
=0;}
...
\indent {\em virtual~ \f$\tilde{}\f$EquiSolnAlgo();} 
//! Does nothing.
...
\indent {\em virtual void Print(OPS\_Stream \&s, int flag = 0) =0;}
