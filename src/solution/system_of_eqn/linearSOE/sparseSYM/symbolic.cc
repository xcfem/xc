...
extern "C" void gennd(int neqns, int **padj, int *mask, int *perm, int *xls, int *ls, int *work);
extern "C" void forminv(int neqns, int *perm, int *invp);
extern "C" int pfordr(int neqns, int **padj, int *perm, int *invp, int *parent, int *fchild, 
	   int *sibling, int *winvp, int *wperm, int *list, int *rowblks);
extern "C" void genrcm(int neqns, int **padj, int *perm, int *mask, int *xls, int *work);
extern "C" void pfblk(int nblks, int *xblk, int *list);

extern "C" int nodfac(int *perm, int *invp, int **padj, int *ancstr , int *list, int neqns, 
	   int nblks, int *xblk, int *envlen, OFFDBLK **segfirst, 
	   OFFDBLK **first, int *rowblks );

extern "C" int setenvlpe(int neqns, double **penv, int *envlen);
extern "C" void copyi( int n, int *, int * );
