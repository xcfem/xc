...
// Revision: A
//
// Description: This file contains the class definition for XC::LinearSOESolver.
// LinearSOESolver is an abstract base class and thus no objects of it's type
// can be instantiated. It has pure virtual functions which must be
// implemented in it's derived classes.  Instances of XC::LinearSOESolver are used
...
//!           = '1' or 'O':  1-norm;
//!           = 'I':         Infinity-norm.
double XC::LinearSOESolver::getRCond(const char &)
  {
