...
and \p mRows is set equal to $0$ and an error message is printed. \\
...
mCols} and \p mRows equal $0$, or skypf2()}. {\em skysf2() is
...
obtained, i.e. the skyss() routine returns $0$ in the INFO
...
creating space for the \p invD work array. Returns $0$ if
