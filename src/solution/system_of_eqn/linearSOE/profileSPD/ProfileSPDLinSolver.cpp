...
// Revision: A
//
// Description: This file contains the class definition for XC::ProfileSPDLinSolver.
// ProfileSPDLinSolver is an abstract base class and thus no objects of it's type
// can be instantiated. It has pure virtual functions which must be
// implemented in it's derived classes.  Instances of XC::ProfileSPDLinSolver 
// are used to solve a system of equations of type XC::ProfileSPDLinSOE.
//
...
bool XC::ProfileSPDLinSolver::setLinearSOE(LinearSOE *soe)
  {
    bool retval= false;
    ProfileSPDLinSOE *tmp= dynamic_cast<ProfileSPDLinSOE *>(soe);
    if(tmp)
      {
        theSOE= tmp;
        retval= true;
