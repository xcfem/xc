...
bool XC::DistributedSparseGenRowLinSOE::setSolver(LinearSOESolver *newSolver)
  {
    ...
    if(tmp)
      ...
      std::cerr << "DistributedSparseGenRowLinSOE::setSolver; solver incompatible con system of equations." << std::endl;
    return retval;
  }
...
int XC::DistributedSparseGenRowLinSOE::addA(const Matrix &m, const ID &id, const double &fact)
  {
