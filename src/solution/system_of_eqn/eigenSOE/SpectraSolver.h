...
#ifndef SpectraSolver_h
#define SpectraSolver_h
...
//! @ingroup EigenSolver
class SpectraSolver: public EigenSolver
  {
  private:
    SpectraSOE *theSOE;
    ...
    SpectraSolver(void);
    SpectraSolver(const int &nModes);
  ...
  public:
    ...
    virtual bool setEigenSOE(SpectraSOE &theSOE);
...
inline EigenSolver *SpectraSolver::getCopy(void) const
   { return new SpectraSolver(*this); }
} // end of XC namespace
