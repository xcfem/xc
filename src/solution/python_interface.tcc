...
class_<XC::SolutionStrategy, bases<CommandEntity>, boost::noncopyable >("SolutionStrategy", "Solution methods container",no_init)
  ...
  .def("getA", &XC::SolutionStrategy::getAPy, "Return a python list containing the rows of the system matrix.")
  .def("getB", &XC::SolutionStrategy::getBPy, "Return a python list containing the rows of the components of the RHS vector.")
...
XC::Analysis *(XC::SolutionProcedure::*get_analysis_ptr)(void)= &XC::SolutionProcedure::getAnalysisPtr;
...
//.add_property("getAnalysis", make_function( &XC::SolutionProcedure::getAnalysis, return_internal_reference<>() )," \n"" Return a reference to the analysis object. \n")
  .add_property("getAnalysis", make_function( get_analysis_ptr, return_internal_reference<>() )," \n"" Return a reference to the analysis object. \n")
