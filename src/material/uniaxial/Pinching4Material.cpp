  ...
  envlpPosDamgdStress(6), envlpNegDamgdStress(6)
{
        ...
        if (error){
                std::cerr << "ERROR: -- input backbone is not unique (one-to-one) , XC::Pinching4Material::Pinching4Material" << "\a";
        }
...
XC::Pinching4Material::Pinching4Material():
...
int XC::Pinching4Material::setTrialStrain(double strain, double CstrainRate)
{
...
double XC::Pinching4Material::getStrain(void) const
  { return Tstrain; }
...
int XC::Pinching4Material::revertToLastCommit(void)
{
...
void XC::Pinching4Material::Print(std::ostream &s, int flag)
{
        ...
        s << "stress: " << Tstress << std::endl;
        s << "state: " << Tstate << std::endl;
}

void XC::Pinching4Material::SetEnvelope(void)
{
...
void XC::Pinching4Material::getstate(double u,double du)
{
        int cid = 0;
        int cis = 0;
        int newState = 0;
 ...
 double XC::Pinching4Material::posEnvlpStress(double u)
                {
                        double k = 0.0;
                        int i = 0;
                        double f = 0.0;
...
double XC::Pinching4Material::posEnvlpTangent(double u)
         {
                        double k = 0.0;
                        int i = 0;
                        while (k==0.0 && i<=4){
 ...
 double XC::Pinching4Material::negEnvlpStress(double u)
                {
                        double k = 0.0;
                        int i = 0;
                        double f = 0.0;
...
double XC::Pinching4Material::negEnvlpTangent(double u)
                {
                        double k = 0.0;
                        int i = 0;
                        while (k==0.0 && i<=4){
...
void XC::Pinching4Material::getState3(XC::Vector& state3Strain, XC::Vector& state3Stress, double kunload)
                {
...
void XC::Pinching4Material::getState4(XC::Vector& state4Strain,XC::Vector& state4Stress, double kunload)
                {
...
double XC::Pinching4Material::Envlp3Tangent(XC::Vector s3Strain, XC::Vector s3Stress, double u)
                        {
                                double k = 0.0;
                                int i = 0;
                                while ((k==0.0||i<=2) && (i<=2))
...
double XC::Pinching4Material::Envlp4Tangent(XC::Vector s4Strain, XC::Vector s4Stress, double u)
                        {
                                double k = 0.0;
                                int i = 0;
                                while ((k==0.0||i<=2) && (i<=2))
  ...
  double XC::Pinching4Material::Envlp3Stress(XC::Vector s3Strain, XC::Vector s3Stress, double u)
                        {
                                double k = 0.0;
                                int i = 0;
                                double f = 0.0;
...
double XC::Pinching4Material::Envlp4Stress(XC::Vector s4Strain, XC::Vector s4Stress, double u)
                        {
                                double k = 0.0;
                                int i = 0;
                                double f = 0.0;
