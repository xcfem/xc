...
XC::CreepMaterial::CreepMaterial(int tag, double _fc, double _fcu, double _epscu, double _ft, double _Ec, double _beta, double _age, double _epsshu, double _epssha, double _tcr, double _epscru, double _epscra, double _epscrd, double _tcast)
  : EncapsulatedUniaxialMaterial(tag, MAT_TAG_CreepMaterial),
    ...
    beta(_beta), epscrd(_epscrd), tcast(_tcast),
    count(0), epsInit(0.0), sigInit(0.0),
    eps_cr(00), eps_sh(0.0), eps_m(0.0), epsP_cr(00), epsP_sh(0.0), epsP_m(0.0),
    eps_total(0.0), epsP_total(0.0), t(0.0), t_load(-1.0), Et(_Ec),
    crack_flag(0), crackP_flag(0.0), iter(0),
    maxSize(startSize)
  {
...
XC::CreepMaterial::CreepMaterial(int tag, UniaxialMaterial &matl, double _age, double _epsshu, double _epssha, double _tcr, double _epscru, double _epscra, double _epscrd, double _tcast)
  : EncapsulatedUniaxialMaterial(tag, MAT_TAG_CreepMaterial, matl),
    tcr(_tcr), age(_age),
    epsshu(_epsshu), epssha(_epssha), epscra(_epscra), epscru(_epscru),
    beta(0.0), epscrd(_epscrd), tcast(_tcast),
    count(0), epsInit(0.0), sigInit(0.0),
    eps_cr(00), eps_sh(0.0), eps_m(0.0), epsP_cr(00), epsP_sh(0.0), epsP_m(0.0),
...
XC::CreepMaterial::CreepMaterial(int tag):
  EncapsulatedUniaxialMaterial(tag, MAT_TAG_CreepMaterial), maxSize(startSize)
  {}
...
int XC::CreepMaterial::sendData(Communicator &comm)
  {
    ...
    res+= comm.sendDoubles(tcr, age, epsshu, epssha, epscra, epscru, getDbTagData(),CommMetaData(4));
    res+= comm.sendDoubles(beta, epscrd, tcast, getDbTagData(),CommMetaData(5));
...
int XC::CreepMaterial::recvData(const Communicator &comm)
  {
    ...
    res+= comm.receiveDoubles(tcr, age, epsshu, epssha, epscra, epscru, getDbTagData(),CommMetaData(4));
    res+= comm.receiveDoubles(beta, epscrd, tcast, getDbTagData(),CommMetaData(5));
