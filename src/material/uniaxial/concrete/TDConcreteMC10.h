...
class TDConcreteMC10 : public TDConcreteMC10Base
  {
  private:
    void Tens_Envlp(double epsc, double &sigc, double &Ect);
  public:
    TDConcreteMC10(int tag= 0);
    TDConcreteMC10(int tag, double _fc, double _ft, double _Ets, double _Ec, double _Ecm, double _beta, double _age, double _tcast, const MC10CreepShrinkageParameters &);
