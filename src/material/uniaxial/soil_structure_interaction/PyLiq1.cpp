...
double XC::PyLiq1::getEffectiveStress(void)
  {
	...
	if(theDomain != 0)
	  {        
	    ...
	    if(theQuad1 != nullptr && theQuad2 != nullptr)
...
int XC::PyLiq1::getMaterialStage(void)
  { return loadStage; }
...
void XC::PyLiq1::updateMaterialStage(int stage)
  {
    if(stage !=0 && stage !=1)
      {
        std::cerr << "PyLiq1::" << __FUNCTION__
...
/////////////////////////////////////////////////////////////////////
int XC::PyLiq1::updateParameter(int snum,Information &eleInformation)
  {
