...
void XC::Template3Dep::allocELS(const EvolutionLaw_S *ELS1_,
...
//! @brief Free ELS1 memory.
void XC::Template3Dep::freeELS1(void)
  {
    if(ELS1)
      {
        delete ELS1;
...
//! @brief Free ELS2 memory.
void XC::Template3Dep::freeELS2(void)
  {
    if(ELS2)
      {
        delete ELS2;
...
//! @brief Free ELS1 memory.
void XC::Template3Dep::freeELS3(void)
  {
    if(ELS3)
      {
        delete ELS3;
...
//! @brief Free ELS4 memory.
void XC::Template3Dep::freeELS4(void)
  {
    if(ELS4)
      {
        delete ELS4;
...
//! @brief Alloc tensorial variables evolution laws.
void XC::Template3Dep::allocELT(const EvolutionLaw_T *ELT1_,
...
//! @brief Free ELT1 memory.
void XC::Template3Dep::freeELT1(void)
  {
    if(ELT1)
      {
        delete ELT1;
...
//! @brief Free ELT2 memory.
void XC::Template3Dep::freeELT2(void)
  {
    if(ELT2)
      {
        delete ELT2;
...
//! @brief Free ELT1 memory.
void XC::Template3Dep::freeELT3(void)
  {
    if(ELT3)
      {
        delete ELT3;
...
//! @brief Free ELT4 memory.
void XC::Template3Dep::freeELT4(void)
  {
    if(ELT4)
      {
        delete ELT4;
...
void XC::Template3Dep::alloc(const NDMaterial *theElMat,
                             const YieldSurface *YS_,
                             const PotentialSurface *PS_,
                             const EPState &EPS_,
...
XC::Template3Dep::Template3Dep(int tag)
 : XC::NDMaterial(tag, ND_TAG_Template3Dep),
   theElasticMat(nullptr), YS(nullptr), PS(nullptr), EPS(),
...
XC::Template3Dep::Template3Dep(int tag,
  ...
  { alloc(&theElMat,&YS_,&PS_,EPS_,&ELS1_); }
...
int XC::Template3Dep::setTrialStrainIncr(const Tensor &v)
  {
    ...
    const EPState &thisEPState = this->getEPS();
    EPState tmp_EPS;
...
//! @brief Free elastic material memory.
void XC::Template3Dep::freeElMat(void)
  {
    if(theElasticMat)
      {
...
//! @brief Get the Elastic material //ZC05/2004
XC::NDMaterial *XC::Template3Dep::getElMat(void) const
  { return theElasticMat; }

//! @brief Set the elastic material.
void XC::Template3Dep::setElMat(const NDMaterial &mat)
  {
    freeElMat();
    theElasticMat= mat.getCopy();
  }


//! @brief Free yield surface memory.
void XC::Template3Dep::freeYS(void)
  {
    if(YS)
      {
        delete YS;
...
//! @brief Get the Yield Surface
XC::YieldSurface * XC::Template3Dep::getYS() const
  { return YS; }

//! @brief Set the yield surface.
void XC::Template3Dep::setYS(const YieldSurface &ys)
  {
    freeYS();
    YS= ys.getCopy();
  }

//! @brief Free potential surface memory.
void XC::Template3Dep::freePS(void)
  {
    if(PS)
      {
        delete PS;
...
//! @brief Get the Potential Surface
XC::PotentialSurface * XC::Template3Dep::getPS() const
  { return PS; }


//! @brief Set the potential surface.
void XC::Template3Dep::setPS(const PotentialSurface &ps)
  {
    freePS();
    PS= ps.getCopy();
  }
...
//! @Get the EPState
const XC::EPState &XC::Template3Dep::getEPS(void) const
  { return EPS; }

void XC::Template3Dep::setEPS(const EPState &eps)
  { EPS= eps; }


//! @brief Get the 1st scalar evolution law
XC::EvolutionLaw_S *XC::Template3Dep::getELS1() const
  { return ELS1; }

//! @brief Assing ELS1.
void XC::Template3Dep::setELS1(const EvolutionLaw_S &els)
  {
    freeELS1();
    ELS1= els.getCopy();
  }
...
//! @brief Get the 2nd scalar evolution law
XC::EvolutionLaw_S *XC::Template3Dep::getELS2() const
  { return ELS2; }

//! @brief Assing ELS2.
void XC::Template3Dep::setELS2(const EvolutionLaw_S &els)
  {
    freeELS2();
    ELS2= els.getCopy();
  }
...
//! @brief Get the third scalar evolution law
XC::EvolutionLaw_S *XC::Template3Dep::getELS3() const
  { return ELS3; }

//! @brief Assing the third scalar evolution law.
void XC::Template3Dep::setELS3(const EvolutionLaw_S &els)
  {
    freeELS3();
    ELS3= els.getCopy();
  }
...
//! @brief Get the fourth scalar evolution law
XC::EvolutionLaw_S *XC::Template3Dep::getELS4() const
  { return ELS4; }

//! @brief Assing the fourth scalar evolution law.
void XC::Template3Dep::setELS4(const EvolutionLaw_S &els)
  {
    freeELS4();
    ELS4= els.getCopy();
  }
...
//! @brief Get the first tensorial evolution law.
XC::EvolutionLaw_T *XC::Template3Dep::getELT1(void) const
  { return ELT1; }

//! @brief Assing the first tensorial evolution law.
void XC::Template3Dep::setELT1(const EvolutionLaw_T &elt)
  {
    freeELT1();
    ELT1= elt.getCopy();
  }
...
//! @brief Get the second tensorial evolution law.
XC::EvolutionLaw_T *XC::Template3Dep::getELT2(void) const
  { return ELT2; }

//! @brief Assing the second tensorial evolution law.
void XC::Template3Dep::setELT2(const EvolutionLaw_T &elt)
  {
    freeELT2();
    ELT2= elt.getCopy();
  }
...
//! @brief Get the third tensorial evolution law.
XC::EvolutionLaw_T *XC::Template3Dep::getELT3() const
  { return ELT3; }

//! @brief Assing the third tensorial evolution law.
void XC::Template3Dep::setELT3(const EvolutionLaw_T &elt)
  {
    freeELT3();
    ELT3= elt.getCopy();
  }
...
//! @brief Get the 4th tensorial evolution law.
XC::EvolutionLaw_T *XC::Template3Dep::getELT4() const
  { return ELT4; }

//! @brief Assing the 4th tensorial evolution law.
void XC::Template3Dep::setELT4(const EvolutionLaw_T &elt)
  {
    freeELT4();
    ELT4= elt.getCopy();
  }
...
//! @brief Predictor EPState by Forward, Backward, MidPoint Methods...
XC::EPState XC::Template3Dep::PredictorEPState(const straintensor &strain_increment)
  {
...
//! @brief New EPState using Forward Euler Algorithm
...
//! @brief Starting EPState using Semi Backward Euler Starting Point.
...
//! @brief New EPState using Backward Euler Algorithm
...
//! @brief New EPState using Forward Euler Subincrement Euler Algorithm
XC::EPState XC::Template3Dep::FESubIncrementation(const straintensor & strain_increment, int number_of_subincrements)
  {
...
//! @brief New EPState using Backward Euler Subincrement Euler Algorithm.
XC::EPState XC::Template3Dep::BESubIncrementation(const straintensor & strain_increment, int number_of_subincrements)
  {
    EPState old_EPS(this->getEPS());
...
//! @brief trying to find intersection point according to M. Crisfield's book
...
//! @brief Routine used by yield_surface_cross to find the stresstensor at cross point
...
//! @brief routine used by zbrentstress, takes an alfa and returns the
