...
#include "material/nD/Template3Dep/RMC01_YS.h"
...
XC::YieldSurface * XC::RMC01YieldSurface::newObj() 
  {  
...
double XC::RMC01YieldSurface::f(const XC::EPState *EPS) const 
  {
...
XC::BJtensor XC::RMC01YieldSurface::dFods(const XC::EPState *EPS) const 
  {
...
double XC::RMC01YieldSurface::xi_s1( const XC::EPState *EPS ) const  
  {
    double p = EPS->getStress().p_hydrostatic();
//    double q = EPS->getStress().q_deviatoric();
//    double theta = EPS->getStress().theta();
...
double XC::RMC01YieldSurface::xi_s2( const XC::EPState *EPS ) const 
  {
//    double p = EPS->getStress().p_hydrostatic();
//    double q = EPS->getStress().q_deviatoric();
//    double theta = EPS->getStress().theta();
...
//BJtensor XC::RMC01YieldSurface::xi_t1( ) const 
//{
...
//================================================================================
std::ostream& XC::operator<< (std::ostream& os, const XC::RMC01YieldSurface & YS)
  {
