...
#include "material/nD/Template3Dep/CAM_YS.h"
...
XC::CAMYieldSurface::CAMYieldSurface(double Mp )  
{
   M = Mp;
} 
...
XC::YieldSurface *XC::CAMYieldSurface::newObj() {  
...
//================================================================================
//
//XC::CAMYieldSurface::CAMYieldSurface(CAMYieldSurface &CAMYS ) { }
//
...
double XC::CAMYieldSurface::f(const XC::EPState *EPS) const
{
...
XC::BJtensor XC::CAMYieldSurface::dFods(const XC::EPState *EPS) const {
...
double XC::CAMYieldSurface::xi_s1( const XC::EPState *EPS ) const {
...
// //#############################################################################
// BJtensor XC::CAMYieldSurface::dpoverds( ) const
//   {
...
// 
// //#############################################################################
// BJtensor XC::CAMYieldSurface::dqoverds(const XC::EPState *EPS) const
//   {
//     
...
// 
// //#############################################################################
// BJtensor XC::CAMYieldSurface::dthetaoverds(const XC::EPState *EPS) const
//   {
//     XC::stresstensor stress = EPS->getStress();
// 
//     BJtensor ret(2, def_dim_2, 0.0);
...
// //out    if ( theta < 0.0001 )
// //out      {
// //out        ::printf("theta = %.10e in XC::CAMYieldSurface::dthetaoverds(stress)\n",
// //out                           theta);
// //out//>><<>><<>><<        return ret;
// //out      }
// 
...
//================================================================================
double XC::CAMYieldSurface::getM() const
{       
    return M;
}
