...
XC::CAMPotentialSurface::CAMPotentialSurface(double Mp )  
  { M = Mp; } 
...
XC::PotentialSurface *XC::CAMPotentialSurface::newObj()
  {  
...
XC::BJtensor XC::CAMPotentialSurface::dQods(const EPState *EPS) const {
...
XC::BJtensor XC::CAMPotentialSurface::d2Qods2(const EPState *EPS) const 
{  
...
XC::BJtensor XC::CAMPotentialSurface::d2Qodsds1(const EPState *EPS) const 
{  
  BJtensor d2Qoverdsds1(2, def_dim_2, 0.0);
  BJtensor DpoDs = EPS->getStress().dpoverds();
...
// //#############################################################################
// BJtensor CAMPotentialSurface::dpoverds( ) const
//   {
...
// 
// //#############################################################################
// BJtensor CAMPotentialSurface::dqoverds(const EPState *EPS) const
//   {
//     
...
// 
// //#############################################################################
// BJtensor CAMPotentialSurface::dthetaoverds(const EPState *EPS) const
//   {
//     stresstensor stress = EPS->getStress();
// 
//     BJtensor ret(2, def_dim_2, 0.0);
...
// //!..........................................................................
// //#############################################################################
// BJtensor CAMPotentialSurface::d2poverds2( void ) const
//   {
...
// 
// //#############################################################################
// BJtensor CAMPotentialSurface::d2qoverds2(const EPState *EPS) const
//   {
//     stresstensor stress = EPS->getStress();
// 
// 
...
//     BJtensor I_pqmn("I", 4, def_dim_4);  // isotropic tensor please see
...
// 
// //#############################################################################
// BJtensor CAMPotentialSurface::d2thetaoverds2(const EPState *EPS) const
//   {
//     stresstensor stress = EPS->getStress();
// 
//     BJtensor ret( 4, def_dim_4, 0.0);
...
//================================================================================
double XC:: CAMPotentialSurface::getM() const
  { return M; }
