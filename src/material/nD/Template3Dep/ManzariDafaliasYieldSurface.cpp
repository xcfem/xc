...
#ifndef ManzariDafaliasYieldSurface_CPP
#define ManzariDafaliasYieldSurface_CPP
...
XC::ManzariDafaliasYieldSurface::ManzariDafaliasYieldSurface( )  { } 
...
//================================================================================
//
//XC::ManzariDafaliasYieldSurface::ManzariDafaliasYieldSurface(ManzariDafaliasYieldSurface &) { }
//
...
double XC::ManzariDafaliasYieldSurface::f(const XC::EPState *EPS) const
{
  ...
  //}
  //else {
  //  std::cerr << "XC::ManzariDafaliasYieldSurface::f  |n_ij| = 0, divide by zero! Program exits.";
  //  exit(-1);
  //}
...
XC::BJtensor XC::ManzariDafaliasYieldSurface::dFods(const XC::EPState *EPS) const {
  ...
  //  }
  //  else {
  //    std::cerr << "XC::ManzariDafaliasYieldSurface::dFods  |n_ij| = 0, divide by zero! Program exits.";
  //    exit(-1);
  //  }
...
double XC::ManzariDafaliasYieldSurface::xi_s1( const XC::EPState *EPS ) const {
...
XC::BJtensor XC::ManzariDafaliasYieldSurface::xi_t1( const XC::EPState *EPS) const {
  BJtensor dFoverds( 2, def_dim_2, 0.0);
  BJtensor I2("I", 2, def_dim_2);
  ...
  //}
  //else {
  //  std::cerr->fatal("XC::ManzariDafaliasYieldSurface::dFods  |n_ij| = 0, divide by zero! Program exits.");
  //  exit(-1);
  //}
  //n = r_bar *(1.0 / sqrt23rd / m );
  ////-------------------------------------------------
