...
#include <set>
#include <string>
#include "nd_material_class_names.h"
...
bool XC::is_nd_material(const std::string &className)
  { return (nd_material_class_names.find(className)!= nd_material_class_names.end()); }
