...
#ifndef MultiaxialCyclicPlasticityAxiSymm_h
#define MultiaxialCyclicPlasticityAxiSymm_h
...
//
//! @brief ??.
class MultiaxialCyclicPlasticityAxiSymm: public MultiaxialCyclicPlasticity {
