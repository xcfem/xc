...
class_<XC::BaseElasticSection1d, XC::BaseElasticSection1d *, bases<XC::BaseElasticSection>, boost::noncopyable >("BaseElasticSection1d", no_init)
...
class_<XC::ElasticSection1d, XC::ElasticSection1d *, bases<XC::BaseElasticSection1d>, boost::noncopyable >("ElasticSection1d")
  .def("getStress", &XC::ElasticSection1d::getStress,"Material stress.")
  ;

// std::vector<XC::BaseElasticSection1d>
...
class_<XC::BaseElasticSection2d, XC::BaseElasticSection2d *, bases<XC::BaseElasticSection>, boost::noncopyable >("BaseElasticSection2d", no_init)
...
class_<XC::BaseElasticSection3d, XC::BaseElasticSection3d *, bases<XC::BaseElasticSection>, boost::noncopyable >("BaseElasticSection3d", no_init)
