...
\noindent {\bf Files}
\indent \#include \f$<\tilde{ }\f$/material/section/SectionForceDeformation.h\f$>\f$
...
\indent // Destructor
\indent {\em virtual \f$\tilde{ }\f$SectionForceDeformation ();}
...
//! SectionForceDeformation objects in the domain is given by \p tag, and whose class
...
\indent {\em virtual int revertToStart (void) = 0; }
//! To revert the section to its initial state. Returns \f$0\f$ if successful
