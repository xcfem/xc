...
\noindent {\bf Files}
\indent \#include \f$<\tilde{ }\f$/material/section/GenericSectionND.h\f$>\f$
...
//! int code);}
\indent // Destructor
\indent {\em \f$\tilde{ }\f$GenericSectionND ();}
...
//! a copy of the NDMaterial \p m via a call to getCopy().
...
\indent {\em int setTrialSectionDeformation (const Vector \&def); }
//! Sets the trial section deformation vector, \f$\esec\f$, to be \p def, then invokes
