...
class_<XC::SectionForceDeformation, XC::SectionForceDeformation *, bases<XC::Material>, boost::noncopyable >("SectionForceDeformation", no_init)
  ...
  .def("getStressResultantComponent",&XC::SectionForceDeformation::getStressResultantByName, "Return the component of the stress vector given its name (i.e., N, My, Mz, T, n12, m12, q22, etc." )
  .def("getStressResultant",make_function(getStressResultantVector, return_internal_reference<>()))
  .def("getSectionDeformationByName",&XC::SectionForceDeformation::getSectionDeformationByName, "Return the component of the strain vector given its name (i.e., defN, defMy, defMz, defT, defn12, defm12, defq22, etc." )
...
class_<XC::PrismaticBarCrossSection, XC::PrismaticBarCrossSection *, bases<XC::SectionForceDeformation>, boost::noncopyable >("PrismaticBarCrossSection", no_init)
  ...
  .def("getCrossSectionProperties1d", &XC::PrismaticBarCrossSection::getCrossSectionProperties1d, " return the 1D properties of the cross section.")
  .def("getCrossSectionProperties2d", &XC::PrismaticBarCrossSection::getCrossSectionProperties2d, " return the 2D properties of the cross section.")
  .def("getCrossSectionProperties3d", &XC::PrismaticBarCrossSection::getCrossSectionProperties3d, " return the 3D properties of the cross section.")
  .def("getElasticSection1d", make_function(&XC::PrismaticBarCrossSection::getElasticSection1d, return_internal_reference<>()), "Return a 1D elastic section material.")
  .def("getElasticSection2d", make_function(&XC::PrismaticBarCrossSection::getElasticSection2d, return_internal_reference<>()), "Return a 2D elastic section material.")
  .def("getElasticShearSection2d", make_function(&XC::PrismaticBarCrossSection::getElasticShearSection2d, return_internal_reference<>()), "Return a 2D elastic shear section material.")
  .def("getElasticSection3d", make_function(&XC::PrismaticBarCrossSection::getElasticSection3d, return_internal_reference<>()), "Return a 3D elastic section material.")
  .def("getElasticShearSection3d", make_function(&XC::PrismaticBarCrossSection::getElasticShearSection3d, return_internal_reference<>()), "Return a 3D elastic shear section material.")
