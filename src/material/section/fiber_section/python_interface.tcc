...
//.def("getCompressedZoneDepth",&XC::FiberSectionBase::getCompressedZoneDepth)
//.def("getCompressedZoneDepth",&XC::FiberSectionBase::getCompressedZoneDepth)
//.def("getTensionedZoneDepth",&XC::FiberSectionBase::getTensionedZoneDepth)
//.def("getTensionedZoneDepth",&XC::FiberSectionBase::getTensionedZoneDepth)
  .def("getInternalForcesAxes",&XC::FiberSectionBase::getInternalForcesAxis)
  ...
  .def("getTensionedPlaneTrace",&XC::FiberSectionBase::getTensionedPlaneTrace,"Return the straight line intersection of a plane perpendicular to the bending plane through the centroid of the tensioned fibers with the plane that contains the fiber section")
  .def("getCompressedPlaneTrace",&XC::FiberSectionBase::getCompressedPlaneTrace,"Return the straight line intersection of a plane perpendicular to the bending plane through the centroid of the compressed fibers with the plane that contains the fiber section")
