...
//.def("getPosiciones",&XC::FiberDeque::getPosiciones)
  ...
  .def("getNeutralAxixDepth",&XC::FiberDeque::getNeutralAxisDepth)
  ...
  .def("getBrazoMecanico",&XC::FiberDeque::getBrazoMecanico)
  ...
  .def("calcRecubrimientos",&XC::FiberDeque::calcRecubrimientos)
  .def("calcSeparaciones",&XC::FiberDeque::calcSeparaciones)
