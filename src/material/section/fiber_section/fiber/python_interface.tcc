...
.def("getAxis1",&XC::FiberPtrDeque::getAxis1, "Return the direction of the major axis of inertia.")
  .def("getAxis2",&XC::FiberPtrDeque::getAxis2, "Return the direction of the minor axis of inertia.")
