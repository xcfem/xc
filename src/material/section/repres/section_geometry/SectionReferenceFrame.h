...
class SectionReferenceFrame: public SectionGeometryWrapper
  {
  protected:
  ...
  public:
    ...
    SectionReferenceFrame(SectionGeometry *m)
      : SectionGeometryWrapper("",m) {}
    SectionReferenceFrame(const std::string &name= "",SectionGeometry *m= nullptr)
      : SectionGeometryWrapper(name,m) {}
