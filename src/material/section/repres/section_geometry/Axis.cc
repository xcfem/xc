...
//! @brief Constructor.
XC::Axis::Axis(SectionGeometry *sr,const size_t &nd)
  : SectionGeometryWrapper("",sr), ndiv(nd) {}

//! @brief Constructor.
//! @param name: object identifier.
//! @param sr: pointer to section geometry.
//! @param nd: number of divisions.
XC::Axis::Axis(const std::string &name,SectionGeometry *sr,const size_t &nd)
  : SectionGeometryWrapper(name,sr), ndiv(nd) {}
