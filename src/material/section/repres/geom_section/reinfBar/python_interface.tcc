...
class_<XC::ReinfBar, XC::ReinfBar *, bases<XC::DiscretBase>, boost::noncopyable >("ReinfBar", no_init)
  ...
  .add_property("getIAxisDirA",make_function(&XC::ReinfBar::IAxisDir_a,return_internal_reference<>()),"Principal inertia axis direction A.")
  .add_property("getIAxisDirB",make_function(&XC::ReinfBar::IAxisDir_b,return_internal_reference<>()),"Principal inertia axis direction B.")
