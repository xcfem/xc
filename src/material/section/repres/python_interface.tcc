...
.def("getDirEjeI_aGrossSection",&XC::SeccionInerte::getDirEjeI_aGrossSection,"Direction of a principal axis of inertia of the gross section with respect of current axis.")
  ...
  .def("getVDirEjeFuerteGrossSection",&XC::SeccionInerte::getVDirEjeFuerteGrossSection,"Direction of the major principal axis of inertia of the gross section.")
.def("getVDirEje2GrossSection",&XC::SeccionInerte::getVDirEje2GrossSection,"Direction of the minor principal axis of inertia of the gross section.")
  .def("getVDirEjeDebilGrossSection",&XC::SeccionInerte::getVDirEjeDebilGrossSection,"Direction of the minor principal axis of inertia of the gross section.")
...
//.def("getIGrossSection",&XC::SeccionInerte::getIGrossSection)
  ...
  .def("getVDirEjeFuerteHomogenizedSection",&XC::SeccionInerte::getVDirEjeFuerteHomogenizedSection,"Direction of the major principal axis of inertia of the homogenized section.")
  ...
  .def("getVDirEjeDebilHomogenizedSection",&XC::SeccionInerte::getVDirEjeDebilHomogenizedSection,"Direction of the minor principal axis of inertia of the homogenized section.")
