...
class_<XC::CrossSectionProperties2d, bases<XC::CrossSectionProperties1d> >("CrossSectionProperties2d")
  ...
  .add_property("i", &XC::CrossSectionProperties2d::getRadiusOfGyration, "Radius of gyration.")
...
class_<XC::CrossSectionProperties3d, bases<XC::CrossSectionProperties2d> >("CrossSectionProperties3d")
  .add_property("Iz", make_function( getIz, return_value_policy<return_by_value>() ), &XC::CrossSectionProperties3d::setIz, "Get/set the moment of inertia around z axis.")
  .add_property("Iy", make_function( getIy, return_value_policy<return_by_value>() ), &XC::CrossSectionProperties3d::setIy, "Get/set the moment of inertia around y axis.")
  .add_property("Iyz", make_function( getIyz, return_value_policy<return_by_value>() ), &XC::CrossSectionProperties3d::setIyz, "Get/set the yz product of inertia.")
  .add_property("iz", &XC::CrossSectionProperties3d::getRadiusOfGyrationZ, "Radius of gyration about z axis.")
  .add_property("iy", &XC::CrossSectionProperties3d::getRadiusOfGyrationY, "Radius of gyration about y axis.")
  ...
  .def("GAy", &XC::CrossSectionProperties3d::GAAlphaY, "Shear stiffness along y axis.")
  .def("GAz", &XC::CrossSectionProperties3d::GAAlphaZ, "Shear stiffness along z axis.")
...
.def("getI1",&XC::CrossSectionProperties3d::getI1, "Get the major principal moment of inertia.")
  .def("getI2",&XC::CrossSectionProperties3d::getI2, "Get the minor principal moment of inertia.")
  .def("getAxis1VDir",&XC::CrossSectionProperties3d::getAxis1VDir, "Get the major principal axis of inertia.")
  .def("getAxis2VDir",&XC::CrossSectionProperties3d::getAxis2VDir, "Get the minor principal axis of inertia.")
  .def("getVDirStrongAxis",&XC::CrossSectionProperties3d::getVDirStrongAxis, "Get the direction of the section strong axis.")
  .def("getVDirWeakAxis",&XC::CrossSectionProperties3d::getVDirWeakAxis, "Get the direction of the section weak axis.")
  ;
