...
class_<XC::SetEstruct, XC::SetEstruct *, bases<XC::SetBase>, boost::noncopyable >("SetEstruct", no_init)
  ...
  .add_property("getNodes", &XC::SetEstruct::getNodesPy, "Return entity nodes. DEPRECATED use nodes.")
  .add_property("getElements", &XC::SetEstruct::getElementsPy, "Return entity elements. DEPRECATED use elements.")
  .add_property("nodes", &XC::SetEstruct::getNodesPy, "Return entity nodes.")
  .add_property("elements", &XC::SetEstruct::getElementsPy, "Return entity elements.")
