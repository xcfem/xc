...
class_<XC::DqPtrsElem, bases<dq_ptrs_element> >("DqPtrsElem",no_init)
  ...
  .def("getTypes",&XC::DqPtrsElem::getTypesPy,"getElementTypes() return a list with the element types in the containe.")
  .def("getMaterials",&XC::DqPtrsElem::getMaterialNamesPy,"getElementMaterials() return a list with the names of the element materials in the containe.")
