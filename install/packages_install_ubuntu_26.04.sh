...
packages_div="\
    ...
    bc \
    graphicsmagick"
# - bc is needed by xc verification tests
# - graphicsmagick is needed to convert between image
#   formats.
...
# Ubuntu 26.04 refuses to install the following packagres system-wide
