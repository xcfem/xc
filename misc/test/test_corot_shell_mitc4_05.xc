...
\mdlr
  {
    ...
    \nodos
      {
        \nod[1]{\setTrialDisp{[1,-1,-1]}}
        \nod[2]{\setTrialDisp{[1,1,-1]}}
        \nod[3]{\setTrialDisp{[1,1,1]}}
        \nod[4]{\setTrialDisp{[1,-1,1]}}

        \nod[11]{\setTrialDisp{[0,-1,-1]}}
        \nod[12]{\setTrialDisp{[0,1,-1]}}
        \nod[13]{\setTrialDisp{[0,1,1]}}
        \nod[14]{\setTrialDisp{[0,-1,1]}}
      }
    \elementos
      {
        \element[0]
          {
            ...
            \set{rfShellCorot= @getResistingForce}
...
\if((@ratio1<1e-15) & (@ratio2<1e-15) & (@ratio3<1e-15) & (@ratio4<1e-15) & (@ratio5<1e-15) & (@ratio6<1e-15))
  {
    \then{\print{"test corot shell MITC4 05: pasa.\n"}}
    \else{\print{"test corot shell MITC4 05: falla.\n"}}
  }