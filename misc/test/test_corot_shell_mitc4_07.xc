...
\mdlr
  {
    \nodos
      {
        ...
        \nod[11]{\coo{0,0.5*(1-@cos45),-0.5*@cos45}}
        \nod[12]{\coo{1,0.5*(1-@cos45),-0.5*@cos45}}
        \nod[13]{\coo{1,0.5*(1+@cos45),0.5*@cos45}}
        \nod[14]{\coo{0,0.5*(1+@cos45),0.5*@cos45}}
      }
    ...
    \nodos
      {
        \nod[1]{\setTrialDisp{[-0.57735,-0.430903,-0.930903]}}
        \nod[2]{\setTrialDisp{[.57735,-0.430903,-0.930903]}}
        \nod[3]{\setTrialDisp{[.57735,0.430903,0.930903]}}
        \nod[4]{\setTrialDisp{[-.57735,0.430903,0.930903]}}

        \nod[11]{\setTrialDisp{[-0.57735,-0.57735,-0.57735]}}
        \nod[12]{\setTrialDisp{[0.57735,-0.57735,-0.57735]}}
        \nod[13]{\setTrialDisp{[0.57735,0.57735,0.57735]}}
        \nod[14]{\setTrialDisp{[-0.57735,0.57735,0.57735]}}
...
\if((@ratio1<1e-6) & (@ratio2<1e-6) & (@ratio3<1e-6) & (@ratio4<1e-6) & (@ratio5<1e-9) & (@ratio6<1e-9))
  {
    \then{\print{"test corot shell MITC4 07: pasa.\n"}}
    \else{\print{"test corot shell MITC4 07: falla.\n"}}
  }
