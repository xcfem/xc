...
refDict= {'className': 'cmb_acc::GroupActionWrapper', 'actions': {'TestActionA': {'className': 'cmb_acc::ActionRepresentativeValues', 'name': 'TestActionA', 'description': 'Test action description A.', 'relations': {'className': 'cmb_acc::ActionRelationships', 'incompatibles': ['IncompA.*', 'IncompB.*'], 'main_actions': ['MainAction1', 'MainAction2'], 'contiene_incomp': False}, 'nodet': False, 'f_pond': 1.0}, 'TestActionB': {'className': 'cmb_acc::ActionRepresentativeValues', 'name': 'TestActionB', 'description': 'Test action description B.', 'relations': {'className': 'cmb_acc::ActionRelationships', 'incompatibles': [], 'main_actions': [], 'contiene_incomp': False}, 'nodet': False, 'f_pond': 1.0}}}
