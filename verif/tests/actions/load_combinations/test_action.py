...
refDict= {'className': 'cmb_acc::Action', 'name': 'TestAction', 'description': 'Test action description.', 'relations': {'className': 'cmb_acc::ActionRelationships', 'incompatibles': ['IncompA.*', 'IncompB.*'], 'main_actions': ['MainAction1', 'MainAction2'], 'contiene_incomp': False}, 'nodet': False, 'f_pond': 3.141592}
