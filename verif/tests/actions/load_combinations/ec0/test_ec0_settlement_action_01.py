...
# Permanent load.
G2= lcg.newSettlementAction(actionName=  'G6', actionDescription= 'Settlement', safetyFactorSet= safetyFactorSet, nonLinearAnalysis= False)
...
error= (ulsFavourable)**2
error+= (ulsUnfavourable-1.20)**2
error+= (ulsFavourableAccidental)**2
error+= (ulsUnfavourableAccidental-1)**2
error+= (slsFavourable)**2
