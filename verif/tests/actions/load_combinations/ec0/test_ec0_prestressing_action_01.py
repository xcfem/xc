...
# Permanent load.
G2= lcg.newPrestressingAction(actionName=  'G5', actionDescription= 'Prestressing', safetyFactorSet= safetyFactorSet, p2Type= False, localVerifications= False)
