...
texFileName= '/tmp/report_load_cases_supertabular.tex'
loadCaseManager.exportToLatex(fileName= texFileName, superTabular= True)
# loadCaseManager.exportToPDF(fileName= './report_load_cases_supertabular.pdf')

## Get current path.
pth= os.path.dirname(__file__)
if(not pth):
    pth= '.'
texFileNameRef= pth+'/../aux/reference_files/ref_report_load_cases_supertabular.tex'
