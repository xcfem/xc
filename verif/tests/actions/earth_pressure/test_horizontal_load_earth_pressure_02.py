...
posA= pos-geom.Vector3d(0,0.5,0.0)
posB= pos+geom.Vector3d(0,0.5,0.0)
# Horizontal load.
H= geom.Vector3d(-5e3,-10e3,0)
loadedLine= hs.HorizontalLinearLoadOnBackfill3D(endPoints= [posA, posB], H= H)
...
ratio3= abs(leverArm-0.9936459362132177)/0.9936459362132177
