...
pos= geom.Pos3d(wallLength/2.0, wallHeight/2.0, wallHeight)
# Horizontal load.
H= geom.Vector3d(-5e3,-10e3,0)
loadedPoint= hs.HorizontalConcentratedLoadOnBackfill3D(pos= pos, H= H)
...
loadedAreaRatio= loadedPoint.appendLoadToCurrentLoadPattern(elements= s.elements, phi= phi, delta= delta)
...
ratio1= (reaction+action).Norm()
ratio2= math.sqrt(reaction[4]**2+reaction[5]**2)
ratio3= abs(leverArm-1.1410393146629525)/1.1410393146629525
