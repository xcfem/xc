...
# Site data
climaticZone= 4 # climatic zone.
z= 560 # height above sea level.

s_k= ec1_snow.get_snow_load_horizontal_terrain(z= z, climaticZone= climaticZone)

gammaSnow= ec1_snow.get_snow_specific_weight(z= z)

error= math.sqrt((s_k-460)**2+(gammaSnow-1.5e3)**2)
