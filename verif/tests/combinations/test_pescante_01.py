...
nod= nodos.newNodeXYZ(2.0,0.0,0.0)
nod= nodos.newNodeXYZ(2.0,0.0,4.0)
nod= nodos.newNodeXYZ(0.0,0.0,4.0)
nod= nodos.newNodeXYZ(5.0,0.0,4.0)
...
for key in combs.getKeys():
  rc.resuelveComb(mdlr,key,analysis,numSteps)
