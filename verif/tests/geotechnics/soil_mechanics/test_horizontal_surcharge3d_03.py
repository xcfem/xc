...
contour= [geom.Pos3d(-0.5,0,10), geom.Pos3d(0.5,0,10), geom.Pos3d(0.5,1,10), geom.Pos3d(-0.5,1,10)]
# Horizontal load.
H= geom.Vector3d(0,-1e3,0)


horizontalSurcharge= hs.HorizontalLoadedAreaOnBackfill3D(contour= contour, H= H)
...
# Check results
ratio1= (shadowCentroid-geom.Pos3d(0.0,-1,7.85899)).getModulus()
ratio2= abs(shadowArea-11.547005383792506)/11.547005383792506
