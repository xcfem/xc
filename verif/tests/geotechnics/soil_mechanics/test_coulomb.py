...
ka1= earth_pressure.ka_coulomb(a= math.radians(0), b= math.radians(0),phi=  math.radians(28), d= math.radians(0))
ka2= earth_pressure.ka_coulomb(a= math.radians(0), b= math.radians(0),phi=  math.radians(30), d= math.radians(5))
ka3= earth_pressure.ka_coulomb(a= math.radians(0), b= math.radians(0),phi=  math.radians(32), d= math.radians(10))
