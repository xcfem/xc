...
pileWall= pw.PileWall(pileSection= pileSection, soilLayersDepths= soilLayersDepths, soilLayers= soilLayers, excavationDepth= L1, pileSpacing= 1.0, waterTableDepth= [None, None])
