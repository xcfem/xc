...
IPE300.sectionClass= sctClass
alpha_IPE300,beta_IPE300=IPE300.getBiaxBendCoeffs(Nd,IPE300.getNcRd())
alpha_IPE300_comp=2
beta_IPE300_comp=5*Nd/1093455.0

IPN300= EC3_materials.IPNShape(steel=S235JR,name='IPN_300')
IPN300.sectionClass= sctClass
alpha_IPN300,beta_IPN300=IPN300.getBiaxBendCoeffs(Nd,IPN300.getNcRd())
alpha_IPN300_comp=2
beta_IPN300_comp=5*Nd/1621500.0

HE300= EC3_materials.HEShape(steel=S235JR,name='HE_300_A')
HE300.sectionClass= sctClass
alpha_HE300,beta_HE300=HE300.getBiaxBendCoeffs(Nd,HE300.getNcRd())
alpha_HE300_comp=2
...
alpha_RHS250,beta_RHS250=RHS250.getBiaxBendCoeffs(Nd/2.,RHS250.getNcRd())
alpha_RHS250_comp=1.66/(1-1.13*(0.5*Nd/2702500.0)**2)
beta_RHS250_comp=1.66/(1-1.13*(0.5*Nd/2702500.0)**2)

CHS193= EC3_materials.CHSShape(steel=S235JR,name='CHS_193.7_11')
CHS193.sectionClass= sctClass
