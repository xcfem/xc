...
reinforcementInf= reinforcement.newStraightReinfLayer(EHE_materials.B400S.getKDiagName())
...
reinforcementSup= reinforcement.newStraightReinfLayer(EHE_materials.B400S.getKDiagName())
