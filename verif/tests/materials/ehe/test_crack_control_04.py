...
concrete= regions.newQuadRegion(EHE_materials.HA25.getKDiagName())
concrete.nDivIJ= 10
concrete.nDivJK= 10
...
reinforcementA= reinforcement.newStraightReinfLayer(EHE_materials.B400S.getKDiagName())
...
reinforcementB= reinforcement.newStraightReinfLayer(EHE_materials.B400S.getKDiagName())
...
reinforcementC= reinforcement.newStraightReinfLayer(EHE_materials.B400S.getKDiagName())
...
secHAParamsFis.computeWk(scc,EHE_materials.HA25.getMatTagK(),EHE_materials.B400S.getMatTagK(),EHE_materials.HA25.fctm())
