...
results= dict()
ef_mode_1_ref= xc.Vector([0, 0.16134533341878296])
ef_mode_2_ref= ef_mode_1_ref
ef_mode_3a_ref= xc.Vector([0, 0.037466046039909])
ef_mode_3b_ref= xc.Vector([0, 0.0224999999999])
...
# for mode in [1, 2, 3, 4]:
#     oh.displayEigenvectors(mode= mode, showRotComponents= False)
