...
avgLeff/=sz
ratio1= abs(avgLeff-9.17089124728)/9.17089124728
avgMechLambda/=sz
ratio2= abs(avgMechLambda-67.3316648310)/67.3316648310
avgEf/=sz
ratio3= abs(avgEf-0.18946099620006)/0.18946099620006
...
if( normal and (ratio1<1e-3) and (ratio2<1e-3) and (ratio3<1e-3) and (ratio3<1e-4)):
    print('test '+fname+': ok.')
else:
