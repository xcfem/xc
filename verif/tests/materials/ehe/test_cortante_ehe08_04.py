...
z=10 #Brazo mecánico.
AsPas=1/4 #Área de la de la armadura longitudinal pasiva traccionada anclada a una distancia mayor que el canto útil de la sección en estudio.
AsAct=1/8 #Área de la de la armadura longitudinal activa traccionada anclada a una distancia mayor que el canto útil de la sección en estudio.
