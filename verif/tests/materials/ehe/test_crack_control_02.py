...
reinforcementInf= reinforcement.newStraightReinfLayer(EHE_materials.B500S.getKDiagName())
...
reinforcementSup= reinforcement.newStraightReinfLayer(EHE_materials.B500S.getKDiagName())
