...
bearing= en.RectangularLaminatedBearing(a= 0.55, b= 0.5, tb= 0.172, ti= 0.011, ts= 2e-3, Te= 0.146, tso= 0.0, Tb= 0.172, n= 12, C= 5e-3, ted= 7e-3, G= 1.15e6)
...
ratio2= abs(reducedArea-185966e-6)/185966e-6
# Shape factor.
...
ratio5= abs(eps_cd-1.649631415301925)/1.649631415301925
# Compute shear strain.
eps_qd= bearing.getShearStrain(vxd= vxd, vyd= vyd)
ratio6= abs(eps_qd-0.7385394465888476)/0.7385394465888476
...
ratio8= abs(eps_td-4.105879676515132)/4.105879676515132
...
ratio9= abs(thk-1.7973042659805538e-3)/1.7973042659805538e-3
...
buckCFRef= 14.8/33.2 # from the Mageba report.
