# -*- coding: utf-8 -*-
''' Prestressing using ElasticBeam2d elements. Home made test.'''
...
concreteSection= concrete.defElasticShearSection2d(preprocessor, sectionProperties)
elements.defaultMaterial= concreteSection.name
elements.defaultTransformation= lin.name
concreteBeam= elements.newElement("ElasticBeam2d",xc.ID([n1.tag,n2.tag]))
