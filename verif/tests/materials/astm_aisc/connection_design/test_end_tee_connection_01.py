...
bltPlate_thck=0.75*units_utils.inchToMeter
bltPlate_steel=ASTM_materials.A36
diag_steel=ASTM_materials.A500
diag_shape=ASTM_materials.HSSShape(diag_steel,'HSS8X6X5/16')
capplat_thck=1*units_utils.inchToMeter  #thickness of the cap plate
weldMetal= ASTM_materials.E7018
w_stem_cap=5/16*units_utils.inchToMeter #weld Tee stem to Tee flange
w_HSS_cap= 5/16*units_utils.inchToMeter #weld diagonal to Tee flange
Nd=125*units_utils.kipToN
...
'''
ratio1=spreadL/units_utils.inchToMeter-6.38
...
l=2*(diag_shape.b()+diag_shape.h()) # length of weld
...
ratio2=(fi*Rn/units_utils.kipToN-195)/195
...
capplat_B=7*units_utils.inchToMeter
capplat_H=9*units_utils.inchToMeter
...
ratio3=(fi*Rn/units_utils.kipToN-125)/125
...
#    print('Local yielding of the HSS wall: CF=',round(CF_yield_HSS,2))
    ratio4=(fi*Rn/units_utils.kipToN-349)/349
...
ratio5=(fi*Rn/units_utils.kipToN-389)/389
...
ratio6=(fi*Rn/units_utils.kipToN-470)/470
