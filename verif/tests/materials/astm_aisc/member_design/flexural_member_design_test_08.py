...
## Points.
span= 7.0*units_utils.footToMeter+6.0*units_utils.inchToMeter
...
## Dead load.
deadLoad= xc.Vector([0.0,-0.145e3*kip2kN/units_utils.footToMeter, 0.0])
cLC= loadCaseManager.setCurrentLoadCase('deadLoad')
for e in xcTotalSet.elements:
    e.vector2dUniformLoadGlobal(deadLoad)
  
## Live load.
liveLoad= xc.Vector([0.0,-0.435e3*kip2kN/units_utils.footToMeter, 0.0])
...
MuRef= 6.67e3*kip2kN*units_utils.footToMeter
