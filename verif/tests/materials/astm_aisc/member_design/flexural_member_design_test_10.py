...
## Dead load.
deadLoad= xc.Vector([0.0,-0.125e3*kip2kN/units_utils.footToMeter, 0.0])
cLC= loadCaseManager.setCurrentLoadCase('deadLoad')
for e in xcTotalSet.elements:
    e.vector2dUniformLoadGlobal(deadLoad)
  
## Live load.
liveLoad= xc.Vector([0.0,-0.375e3*kip2kN/units_utils.footToMeter, 0.0])
...
E= shape.get('E')
MuRef= 0.9*47.2e3*kip2kN*units_utils.footToMeter
...
print('Ieff: ', shape.Ieff, ' m4(', shape.Ieff/(units_utils.inchToMeter**4), ' in4)')
