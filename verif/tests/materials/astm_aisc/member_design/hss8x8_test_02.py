...
Fcr= member.getCompressiveCriticalStress()
compressiveBucklingReductionLimit= member.shape.getCompressiveBucklingReductionLimit(Fcr)
h_eff= member.shape.getReducedEffectiveH(compressiveBucklingReductionLimit, Fcr)
b_eff= member.shape.getReducedEffectiveB(compressiveBucklingReductionLimit, Fcr)
A_eff= member.shape.getCompressionEffectiveArea(Fcr)
