...
## Points.
span= 21.0*units_utils.footToMeter
...
## Dead load.
deadLoad= xc.Vector([0.0,-0.15e3*kip2kN/units_utils.footToMeter, 0.0])
cLC= loadCaseManager.setCurrentLoadCase('deadLoad')
for e in xcTotalSet.elements:
    e.vector2dUniformLoadGlobal(deadLoad)
  
## Live load.
liveLoad= xc.Vector([0.0,-0.4e3*kip2kN/units_utils.footToMeter, 0.0])
...
MuRef= 0.9*Mn
MuRefText= 0.9*63.3e3*kip2kN*units_utils.footToMeter
...
print('Mn= ',Mn/1e3,' kN m(',Mn/1e3*kN2kips/units_utils.footToMeter,' kip-ft)')
