...
halfSide= 5 # Typical span for building.
## Problem geometry.
#                     p7
# p4 +----------------+----------------+ p3
#    |                |                |
...
p3= modelSpace.newKPoint(halfSide, halfSide, 5)
p4= modelSpace.newKPoint(-halfSide, halfSide, 5)
### mid-points
p5= modelSpace.newKPoint(0, -halfSide, 5)
p6= modelSpace.newKPoint(halfSide, 0, 5)
p7= modelSpace.newKPoint(0, halfSide, 5)
...
slabs.append(modelSpace.newQuadSurface(p8, p9, p7, p4))
slabs.append(modelSpace.newQuadSurface(p5, p2, p6, p9))
slabs.append(modelSpace.newQuadSurface(p9, p6, p3, p7))
for s in slabs:
    s.setElemSizeIJ(.2, .2)
...
betaRef= 1.05 # Minimum value of beta.
error= abs(beta-betaRef)/betaRef
