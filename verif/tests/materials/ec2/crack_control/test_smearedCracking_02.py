...
Etsdiag, ftdiag= concrAux.getEts(concrMat= concrAux, reinfMat=rfSteel, reinfRatio=ro_exp,diagType='K', fct_exp= fct_exp, Ec_exp= Ec_exp, fy_exp= fy_exp, Es_exp= Es_exp, regressionLine= False)
