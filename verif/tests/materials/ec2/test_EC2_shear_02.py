...
Asw= numberOfLegs*stirrupsArea # cross-sectional area of the shear rei nforcement
...
VRdsA= EC2_limit_state_checking.getShearResistanceShearReinf(concrete= concrete, NEd= 0.0, Ac= Ac, bw= bw, Asw= Asw, s= stirrupSpacing, z= z, reinfSteel= stirrupsSteel, shearReinfAngle= math.pi/2.0, strutAngle= theta, nationalAnnex= None)
...
nu= concrete.getShearStrengthReductionFactor()
theta= math.asin(math.sqrt(Asw*fyd/(bw*stirrupSpacing*nu*-concrete.fcd())))
VRdsB= EC2_limit_state_checking.getShearResistanceShearReinf(concrete= concrete, NEd= 0.0, Ac= Ac, bw= bw, Asw= Asw, s= stirrupSpacing, z= z, reinfSteel= stirrupsSteel, shearReinfAngle= math.pi/2.0, strutAngle= theta, nationalAnnex= None)
...
# nu= concrete.getShearStrengthReductionFactor()
# theta= math.asin(math.sqrt(Asw*fyd/(bw*stirrupSpacing*nu*-concrete.fcd())))
# VRdsC= EC2_limit_state_checking.getShearResistanceShearReinf(concrete= concrete, NEd= 0.0, Ac= Ac, bw= bw, Asw= Asw, s= stirrupSpacing, z= z, reinfSteel= stirrupsSteel, shearReinfAngle= math.pi/2.0, strutAngle= theta, nationalAnnex= None)
# VRdsCRef= 701e3
