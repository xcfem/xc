...
secHP= geomSecPret02.getFiberSection3d("secHP")

elem= zlElement, nodA, nodB= scc3d_testing_bench.section_model(preprocessor, secHP.name)
...
concrFibers= fiber_sets.FiberSet(scc,'concrete',EHE_materials.HP45.getMatTagD())
