...
iyTeor= (nRebars*As+2*As/4.0)*(width/2.0)**2 # add mid point reinforcement Iy.
...
nRebarsTot= nRebars+2 # original + mid points.
totalArea+= 2*(As/4) # area of the mid points reinforcement.
