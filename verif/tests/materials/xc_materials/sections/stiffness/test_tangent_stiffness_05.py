...
''' Verifies that stiffness properties are returned from the correct element
    of the stiffness matrix. Section type: ElasticShearSection2d. 
    Home made test.
'''
...
xcSectionA= steelSectionA.defElasticShearSection2d(preprocessor= preprocessor)
...
xcSectionB= steelSectionB.defElasticShearSection2d(preprocessor= preprocessor)
