...
''' Verifies that stiffness properties are returned from the correct element
    of the stiffness matrix. Section type: ElasticSection2d. 
    Home made test.
'''
...
xcSectionA= steelSectionA.defElasticSection2d(preprocessor= preprocessor)
...
xcSectionB= steelSectionB.defElasticSection2d(preprocessor= preprocessor)
