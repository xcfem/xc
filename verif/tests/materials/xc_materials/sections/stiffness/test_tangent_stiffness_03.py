...
''' Verifies that stiffness properties are returned from the correct element
    of the stiffness matrix. Section type: ElasticShearSection3d. 
    Home made test.
'''
...
def compare_values(steelShape, xcSection):
    ...
    :param xcSection: XC ElasticShearSection3d object.
    '''
    retval= 0.0
    EA1= steelShape.EA()
    EA2= xcSection.EA()
...
xcSectionA= steelSectionA.defElasticShearSection3d(preprocessor= preprocessor)
...
xcSectionB= steelSectionB.defElasticShearSection3d(preprocessor= preprocessor)
errB= compare_values(steelShape= steelSectionB, xcSection= xcSectionB)

'''
print('errA= ', errA)
print('errB= ', errB)
print(xcSectionA.getTangentStiffness())
print(xcSectionB.getTangentStiffness())
'''
