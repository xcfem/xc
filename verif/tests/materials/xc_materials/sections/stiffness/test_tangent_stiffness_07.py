...
''' Verifies that stiffness properties are returned from the correct element
    of the stiffness matrix. Section type: ElasticSection1d. 
    Home made test.
'''
...
xcSectionA= steelSectionA.defElasticSection1d(preprocessor= preprocessor)
...
xcSectionB= steelSectionB.defElasticSection1d(preprocessor= preprocessor)
