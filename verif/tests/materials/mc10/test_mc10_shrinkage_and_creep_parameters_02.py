...
# t0: loading age (days).
parameters= MC10_td_concrete.ShrinkageAndCreepParameters(concrete= concrete, cement= '32.5N', h0= 0.124, T= 21, RH= 70, ts= 7, t0= 7)
...
ratio1= abs(opensees_epsba+6.000224021555357e-05)/6.000224021555357e-5
opensees_epsbb= parameters.get_opensees_epsbb()
ratio2= abs(opensees_epsbb-1)
opensees_epsda= parameters.get_opensees_epsda()
ratio3= abs(opensees_epsda+0.00036470979263482746)/0.00036470979263482746
opensees_epsdb= parameters.get_opensees_epsdb()
ratio4= abs(opensees_epsdb-538.16)/538.16
