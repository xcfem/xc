...
refGH= geom.Pos2d(0.00108338, 0.0)
...
print(testRCSection.shReinfY.nShReinfBranches)
print(testRCSection.getShearReinfY().nShReinfBranches)
print(ratio6)
'''
