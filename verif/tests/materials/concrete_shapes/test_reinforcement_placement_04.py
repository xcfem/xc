...
meanCFs= limitState.check(setCalc= None, crossSections= reinfConcreteSectionDistribution, controller= controller, appendToResFile=False,listFile=False,calcMeanCF=True, threeDim= True)
...
ratio1= abs(meanCFs[0]-0.49950728427076807)/0.49950728427076807
ratio2= abs(meanCFs[1]-0.515124379921859)/0.515124379921859
