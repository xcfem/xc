...
nominalCover= .025
rcSection= def_simple_RC_section.RCRectangularSection(name= "Test", sectionDescr= "Test reinforce concrete section.", concrType= EHE_materials.HA25, reinfSteelType= EHE_materials.B500S, width= 0.25, depth= 0.5)
