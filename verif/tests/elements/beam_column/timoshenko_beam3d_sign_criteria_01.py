...
def getInternalForcesBeginNode(elem):
    ...
    # Return of internal torsional forces for timoshenko elements not implemented yet.
    T1= 0.0 # elem.getT1
    return (elem.getN1,elem.getVy1,elem.getVz1,T1,elem.getMy1,elem.getMz1)

def getInternalForcesEndNode(elem):
    ''':return: internal forces on the element's last node.''' 
    # Return of internal torsional forces for timoshenko elements not implemented yet.
    T2= 0.0 # elem.getT2
    return (elem.getN2,elem.getVy2,elem.getVz2,T2,elem.getMy2,elem.getMz2)
...
sectionProperties.AlphaI= 1.0; sectionProperties.AlphaZ= 1.0
section= typical_materials.defElasticShearSectionFromMechProp3d(preprocessor, "section",sectionProperties)
...
lp0.newNodalLoad(n2.tag,xc.Vector([F,0,0,0,0,0])) # Positive force along x axis
...
lp1.newNodalLoad(n2.tag,xc.Vector([0,F,0,0,0,0])) # Positive force along y axis
# We add the load case to domain.
...
lp2.newNodalLoad(n2.tag,xc.Vector([0,0,F,0,0,0])) # Positive force along z axis
# We add the load case to domain.
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!! RETURN OF TORSIONAL INTERNAL FORCES NOT IMPLEMENTED YET !!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

lp3.newNodalLoad(n2.tag,xc.Vector([0,0,0,F,0,0])) # Positive moment about x axis
# We add the load case to domain.
...
print('Mz1= ', Mz1)
print('ratio35= ', ratio35)
print("RF= ",RF)
printResults(N1,Vy1,Vz1,T1,My1,Mz1,N2,Vy2,Vz2,T2,My2,Mz2,phaseRatios,'3')
'''

lp4= modelSpace.newLoadPattern(name= '4')
lp4.newNodalLoad(n2.tag,xc.Vector([0,0,0,0,F,0])) # Positive moment about y axis
# We add the load case to domain.
modelSpace.addLoadCaseToDomain("4")
...
'''
print('N1= ', N1)
print('ratio40= ', ratio40)
print('Vy1= ', Vy1)
print('ratio41= ', ratio41)
print('Vz1= ', Vz1)
print('ratio42= ', ratio42)
print('My1= ', My1)
print('ratio44= ', ratio44)
print('Mz1= ', Mz1)
print('ratio45= ', ratio45)
print("RF= ",RF)
...
lp5.newNodalLoad(n2.tag,xc.Vector([0,0,0,0,0,F])) # Positive moment about z axis
# We add the load case to domain.
modelSpace.addLoadCaseToDomain("5")
...
'''
print('N1= ', N1)
print('ratio50= ', ratio50)
print('Vy1= ', Vy1)
print('ratio51= ', ratio51)
print('Vz1= ', Vz1)
print('ratio52= ', ratio52)
print('My1= ', My1)
print('ratio54= ', ratio54)
print('Mz1= ', Mz1)
print('ratio55= ', ratio55)
print("RF= ",RF)
