...
nodes= preprocessor.getNodeHandler 
delta= n1.getDisp[2]  # z displacement of node 2 global
...
Mz2teor= -f*L*L/2
ratio2= abs(Mz2-Mz2teor)/Mz2teor
ratio3= abs(Mz1)
Vy2teor= f*L
ratio4= abs(Vy2-Vy2teor)/Vy2teor
ratio5= abs(Vy1)
ratio6= abs(Vy-Vy2teor/2.0)/(Vy2teor/2.0)
...
print("ratio1= ",ratio1)
print("Mz2= ",Mz2)
print("Mz2teor= ",Mz2teor)
print("ratio2= ",ratio2)
print("Mz1= ",Mz1)
print("Mz1teor= ",0)
print("ratio3= ",ratio3)
print("Vy2= ",Vy2)
print("Vy2teor= ",Vy2teor)
print("ratio4= ",ratio4)
print("Vy1= ",Vy1)
print("Vy2teor= ",0)
print("ratio5= ",ratio5)
