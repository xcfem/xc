...
delta= n1.getDisp[1]  # Node 2 yAxis displacement global
...
My2teor= -f*L*L/2
ratio2= abs((My2-My2teor)/My2teor)
ratio3= abs(My1)
Vz2teor= -(f*L)
ratio4= abs(Vz2-Vz2teor)/Vz2teor
ratio5= abs(Vz1)
...
print("ratio1= ",ratio1)
print("My2= ",My2)
print("My2teor= ",My2teor)
print("ratio2= ",ratio2)
print("My1= ",My1)
print("My1teor= ",0)
print("ratio3= ",ratio3)
print("Vz2= ",Vz2)
print("Vz2teor= ",Vz2teor)
print("ratio4= ",ratio4)
print("Vz1= ",Vz1)
print("Vz1teor= ",0)
print("ratio5= ",ratio5)
...
if (abs(ratio1)<1e-5) & (abs(ratio2)<1e-10) & (ratio3<1e-5) & (abs(ratio4)<1e-5) & (ratio5<1e-5):
    print('test '+fname+': ok.')
else:
