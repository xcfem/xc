...
ratio11= abs(Vy1)+abs((Vy2-Vy2Teor)/Vy2)
ratio12= abs(Vz1)+abs(Vz2)
ratio13= abs(T1)+abs(T2)
ratio14= abs(My1)+abs(My2)
ratio15= abs(Mz1)+abs((Mz2-Mz2Teor)/Mz2)
...
ratio22= abs(Vz1)+abs((Vz2-Vz2Teor)/Vz2)
ratio23= abs(T1)+abs(T2)
ratio24= abs(My1)+abs((My2-My2Teor)/My2)
...
ratio32= abs(Vz1)+abs((Vz2-Vz2Teor)/Vz2)
ratio33= abs(T1)+abs(T2)
ratio34= abs(My1)+abs((My2-My2Teor)/My2)
