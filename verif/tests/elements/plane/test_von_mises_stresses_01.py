...
The FourNodeQuad element doesn't give very accurate results.
'''
...
# Material definition
steel2d= typical_materials.defElasticIsotropicPlaneStress(preprocessor, "steel2d",E= E,nu= nu, rho= 0.0)
...
#s.nDivI= 60 # Number of divisions on p1->p2 and p3->p4
...
### Get the line between p2 and p3
...
n3= p3.getNode()
lp0.newNodalLoad(n3.tag,xc.Vector([0.0,load]))
...
e= n1.connectedElements[0] # element connected to n1.
...
vMisesRef= math.sqrt(sg11*sg11+sg11*sg22+sg22*sg22+3.0*sg12*sg12)
...
if(ratio1<0.05 and ratio2<0.06 and ratio3<0.3): # A bit deceptive ratio 3, it's true.
    print('test '+fname+': ok.')
else:
