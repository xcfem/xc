...
frictionPendulumBearing= fb.def_single_friction_pendulum_bearing_2d(modelSpace, n1= nod1, n2= nod2, frictionModel= frictionModel, vertResp= axialMat, rotResp= rotMat, kInit= kInit, rEff= Reff, x= xc.Vector([0,1,0]), y= xc.Vector([-1,0,0]), shearDistI= 0.0, addRayleigh= 0, mass= mass)
...
testOK&= (maxIter==20) and (tol==1e-12) and (length==0.0)
