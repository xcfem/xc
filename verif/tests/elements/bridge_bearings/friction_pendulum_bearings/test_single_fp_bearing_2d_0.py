# -*- coding: utf-8 -*-
''' Dummy FlatSiderSimple2d adapted from TestFPS2d_0.tcl

Purpose: this file tests the 2D SingleFPBearing element. It models a rigid ç
isolated mass and the bearing element has zero length. It also tests the 
...
# 5. Define elements
Reff= 34.68
bearing= fb.def_single_friction_pendulum_bearing_2d(modelSpace, n1= n1, n2= n2, frictionModel= frictionModel, vertResp= vertResp, rotResp= rotResp, kInit= 250.0, rEff=Reff, x= xc.Vector([0,1,0]), y= xc.Vector([-1,0,0]))
