...
# 5. Define elements
bearing1= fb.def_flat_slider_bearing_2d(modelSpace, n1= n1, n2= n2, frictionModel= frictionModel, vertResp= vertResp, rotResp= rotResp, kInit= 250.0)
bearing4= fb.def_flat_slider_bearing_2d(modelSpace, n1= n4, n2= n5, frictionModel= frictionModel, vertResp= vertResp, rotResp= rotResp, kInit= 250.0)
