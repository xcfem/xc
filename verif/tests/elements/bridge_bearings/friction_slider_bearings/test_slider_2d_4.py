...
# 5. Define elements
bearing1= fb.def_flat_slider_bearing_2d(modelSpace, n1= nodeDict[1], n2= nodeDict[2], frictionModel= frictionModel, vertResp= vertResp, rotResp= rotResp, kInit= 250.0)
bearing8= fb.def_flat_slider_bearing_2d(modelSpace, n1= nodeDict[8], n2= nodeDict[9], frictionModel= frictionModel, vertResp= vertResp, rotResp= rotResp, kInit= 250.0)
