# -*- coding: utf-8 -*-
''' Dummy FlatSiderSimple3d regression test.'''
...
kInit= 250.0
mass= 1.0
flatSliderBearing= fb.def_flat_slider_bearing_3d(modelSpace, n1= nod1, n2= nod2, frictionModel= frictionModel, vertResp= axialMat, rotRespX= rotMatX, rotRespY= rotMatY, rotRespZ= rotMatZ, kInit= kInit, x= xc.Vector([0,1,0]), y= xc.Vector([-1,0,0]), shearDistI= 0.0, addRayleigh= 0, mass= mass)
...
testOK&= (maxIter==25) and (tol==1e-8) and (length==0.0)
