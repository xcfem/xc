...
nod3.fix(xc.ID([2]),xc.Vector([0]))
nod4.fix(xc.ID([2]),xc.Vector([0]))
fixedNodes= [nod1, nod2, nod3, nod4]

# Load definition.
lp0= modelSpace.newLoadPattern(name= '0')

lp0.newNodalLoad(nod5.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(nod6.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(nod7.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(nod8.tag, xc.Vector([0,0,-1]))
