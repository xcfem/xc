...
n3.fix(xc.ID([2]),xc.Vector([0]))
n4.fix(xc.ID([2]),xc.Vector([0]))
fixedNodes= [n1, n2, n3, n4]

# Load definition.
lp0= modelSpace.newLoadPattern(name= '0')

lp0.newNodalLoad(n5.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(n6.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(n7.tag, xc.Vector([0,0,-1]))
lp0.newNodalLoad(n8.tag, xc.Vector([0,0,-1]))
