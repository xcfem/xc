...
## load pattern.
load= xc.Vector([0.0,35e3,uniformLoad]) # Small "in-plane" load to check it has a moderate effect on results (see test description at top).
...
oh.displayFieldDirs1and2(limitStateLabel= limitState.label, argument= 'CF', setToDisplay= xcTotalSet, component=None, fileName= outputFileName, defFScale=0.0, rgMinMax= None)
