# -*- coding: utf-8 -*-
''' Check that the displayNodeValueDiagram method works with node attributes. 
    The test does not verify the output contents, only that the method runs 
...
oh.displayNodeValueDiagram(itemToDisp= 'tag', caption= 'Test', setToDisplay= None, fUnitConv= 1.0, unitDescription= '', fileName= outputFileName)

# oh.displayNodeValueDiagram(itemToDisp= 'tag', caption= 'Test', setToDisplay= None, fUnitConv= 1.0, unitDescription= '', fileName= None)
