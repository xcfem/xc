# -*- coding: utf-8 -*-
''' Test displaying strain loads on Force Beam-Column 2D elements. Home made 
    test.
'''
...
beam2dA= elements.newElement("ForceBeamColumn2d",xc.ID([n1.tag, n2.tag]))
beam2dB= elements.newElement("ForceBeamColumn2d",xc.ID([n11.tag,n12.tag]))
beam2dC= elements.newElement("ForceBeamColumn2d",xc.ID([n21.tag,n22.tag]))
