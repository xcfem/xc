...
beamThermalDeformation= xc.DeformationPlane(alpha*AT)
beamEleLoad.backEndDeformationPlane= beamThermalDeformation
beamEleLoad.frontEndDeformationPlane= beamThermalDeformation
