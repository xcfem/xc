...
linB= modelSpace.newLinearCrdTransf("linB",xc.Vector([0,-1,0]))
...
for e in xcTotalSet.elements:
    MzValues.append(cv.getElementInternalForceComponentData(e, 'Mz'))
...
error= 0.0
for values, refValues in zip(MzValues,refMzValues):
