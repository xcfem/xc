...
from materials.nbe_ea95 import NBE_EA95_materials
from materials.nbe_ea95 import NBE_EA95_limit_state_checking
...
#plateFiber= steel.defElasticMembranePlateSection(preprocessor= preprocessor, name= 'plateFiber', thickness= t)
