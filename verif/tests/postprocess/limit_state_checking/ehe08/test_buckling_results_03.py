...
l1.nDiv= 6
### Flat column (short column to make sure this column doesn't affect the first buckling modes).
p4= modelSpace.newKPoint(5,0,H/10.0) 
...
calcSet= xcTotalSet
bucklingParametersLSD= EHE_limit_state_checking.BucklingParametersLimitStateData(numModes= 4, alpha_cr_threshold= 25.0) # alpha_cr_threshold= 25.0 is clearly excessive
...
meanCFs= bucklingParametersLSD.check(setCalc= calcSet, crossSections= reinfConcreteSectionDistribution,appendToResFile=False,listFile=False,calcMeanCF=True, controller= controller, threeDim= True)
...
ratio1= abs(meanCFs[0]-0.44643380777127867)/0.44643380777127867
ratio2= abs(meanCFs[1]-0.4490449092123047)/0.4490449092123047
