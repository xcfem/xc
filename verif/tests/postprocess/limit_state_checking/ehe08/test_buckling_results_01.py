...
calcSet= xcTotalSet
bucklingParametersLSD= EHE_limit_state_checking.BucklingParametersLimitStateData(numModes= 4, alpha_cr_threshold= 70.0) # alpha_cr_threshold= 70.0 is clearly excessive
...
ratio1= abs(meanCFs[0]-0.4711610593066006)/0.4711610593066006
ratio2= abs(meanCFs[1]-0.4691913767340548)/0.4691913767340548
