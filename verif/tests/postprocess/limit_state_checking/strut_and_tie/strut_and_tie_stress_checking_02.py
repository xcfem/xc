# -*- coding: utf-8 -*-
''' Trivial test cheching report generation of a limit state analysis on a strut-and-tie model when control variables are generated by the ckecking algorithm (instead of read from a file).'''
