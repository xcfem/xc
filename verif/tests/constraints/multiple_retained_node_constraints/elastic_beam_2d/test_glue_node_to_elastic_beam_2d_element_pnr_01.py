# -*- coding: utf-8 -*-
''' Check newGlueNodeToElement function with penalty Newton-Raphson solutionalgorithm.
...
analysis= predefined_solutions.penalty_newton_raphson(feProblem, maxNumIter= 10, printFlag=0) # => OK 14/08/2026.
