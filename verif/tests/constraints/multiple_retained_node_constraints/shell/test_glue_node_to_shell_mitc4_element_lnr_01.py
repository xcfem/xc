# -*- coding: utf-8 -*-
''' Check newGlueNodeToElement function with Lagrange Newton-Raphson solution
algorithm.
...
analysis= predefined_solutions.lagrange_newton_raphson(feProblem, maxNumIter= 2) # => KO
