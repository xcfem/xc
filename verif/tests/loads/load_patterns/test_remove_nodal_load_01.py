# -*- coding: utf-8 -*-
''' Trivial test for removing an existing nodal load.'''
...
nL1= testLP.newNodalLoad(n1.tag, loadVector)
nL2= testLP.newNodalLoad(n2.tag, loadVector)
nL3= testLP.newNodalLoad(n3.tag, loadVector)
## Apply load pattern.
...
nL2Tag= nL2.tag # Get the identifier of interest.
nL2= None # Avoid calling an object that doesn't exist anymore.
testLP.removeNodalLoad(nL2Tag)
...
err= math.sqrt((R0-3*F)**2+(R1-2*F)**2)

'''
print(nL1.tag, nL3.tag)
print('R0= ', R0/1e3)
print('R1= ', R1/1e3)
print('err= ', err)
'''
