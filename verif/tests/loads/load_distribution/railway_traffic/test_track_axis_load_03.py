...
nodalLoads= trackAxis.defDeckCentrifugalLoadOnRailsThroughLayers(trainModel= trainLoadModel, relativePosition= 0.5, v= v, Lf= Lf, r= r, trackCrossSection= trackCrossSection, spreadingLayers= spreadingLayers, deckThickness= deckThickness, deckSpreadingRatio= 1/1, originSet= slabSet)
