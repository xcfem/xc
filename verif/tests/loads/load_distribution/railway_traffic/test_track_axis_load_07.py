...
nodalLoads= trackAxis.defDeckWindLoadThroughLayers(trainModel= trainLoadModel, windPressure= windPressure, spreadingLayers= spreadingLayers, deckThickness= deckThickness, deckSpreadingRatio= 1/1, originSet= slabSet, windDirection= windDirection)
