...
nodalLoads= uniformRailLoad1.defDeckRailUniformLoadsThroughLayers(spreadingLayers= spreadingLayers, originSet= loadedSet, deckMidplane= deckMidplane, deckThickness= deckThickness)
nodalLoads.extend(uniformRailLoad2.defDeckRailUniformLoadsThroughLayers(spreadingLayers= spreadingLayers, originSet= loadedSet, deckMidplane= deckMidplane, deckThickness= deckThickness))
...
refTotalLoad= uniformRailLoad1.getDynamicLoad()*uniformRailLoad1.railAxis.getLength()+uniformRailLoad2.getDynamicLoad()*uniformRailLoad2.railAxis.getLength()
