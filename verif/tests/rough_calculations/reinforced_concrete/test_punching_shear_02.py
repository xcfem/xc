...
# Problem geometry
d=0.15 # effective depth of the slab
a=0.25 # column depth
b=0.25 # column width
A= 5*5 # column tributary area.
h=0.20 # slab thickness
...
ratio2= (Vdmax-540e3)/540e3
ratio3= (Aws-46.265857454955004e-4)/46.265857454955004e-4
