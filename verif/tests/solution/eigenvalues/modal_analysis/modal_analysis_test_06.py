...
# Solution procedure
analysis= predefined_solutions.frequency_analysis(feProblem, systemPrefix= 'spectra')
...
exampleModes= xc.Matrix([[0.323,-0.764,-0.946],
                         [0.521,-0.941,-0.378],
                         [0.685,-0.700,0.672],
                         [0.891,0.241,1.000],
                         [1.000,1.000,-0.849]])
diff_modes= (modes-exampleModes)
...
print("reference periods: ", targetPeriods) 
print("ratio1= ",ratio1)
...
if((ratio1<1e-3) & (ratio3<1e-12) & (abs(ratio4)<5e-2)):
    print('test '+fname+': ok.')
else:
