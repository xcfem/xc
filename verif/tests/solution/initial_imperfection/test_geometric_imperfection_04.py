# -*- coding: utf-8 -*-
''' Check shell MITC4 elements update after a "manual" change in the position 
of the nodes.'''
...
elem= modelSpace.newSeedElement("ShellMITC4")
...
for rElement in replicantElements:
    ...
    newElement= modelSpace.newElement("ShellMITC4", newNodeTags)
...
analysis= predefined_solutions.simple_static_linear(steelColumn)
...
for n in xcTotalSet.nodes:
    ...
    if(yDisp>mxDisp):
        mxDisp= yDisp
leverArm= e0 # +mxDisp second order effects neglected.
