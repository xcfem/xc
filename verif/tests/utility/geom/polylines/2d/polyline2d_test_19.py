...
# Define polyline.
pline= geom.Polyline2d([geom.Pos2d(1,0), geom.Pos2d(1,1), geom.Pos2d(0,1)])
...
ref_normals= [geom.Vector2d(1,0), geom.Vector2d(half_sqrt_2, half_sqrt_2), geom.Vector2d(0,1)]
