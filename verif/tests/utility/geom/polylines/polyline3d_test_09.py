# -*- coding: utf-8 -*-
'''Test Polyline3d::getProjection method. Home cooked test.'''
...
# Define polyline.
points= [geom.Pos3d(0, 0, 0), geom.Pos3d(1, 0, 0), geom.Pos3d(1,1, 0)]
pline= geom.Polyline3d(points)

# Project a point.
pt= geom.Pos3d(1.5, 0.5, 0)
...
err= math.sqrt(projection.dist2(geom.Pos3d(1.0, 0.5, 0))+(lengthUpTo-1.5)**2)
