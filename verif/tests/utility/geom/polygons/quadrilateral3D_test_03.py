# -*- coding: utf-8 -*-
''' Interpolate reinforcement directions in an irregular slab (3D version).'''
...
slabCorners= [geom.Pos3d(0,5901.36865234375e-3, 36112.4765625e-3),
              geom.Pos3d(0,-2754.543701171875e-3, 36112.4765625e-3),
              ...
              geom.Pos3d(0,7165.8857421875e-3, 31553.732421875e-3)]
# Get the vertices.
...
quadA= geom.Quadrilateral3d(p1, p2, p3, p4)
quadADirections= [edge2Dir, edge1Dir, edge1Dir, edge2Dir]
quadB= geom.Quadrilateral3d(p0, p1, p4, p5)
