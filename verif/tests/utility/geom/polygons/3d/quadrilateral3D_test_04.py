# -*- coding: utf-8 -*-
''' Quadrilateral3D class. Test getBilinearGrid method.'''
...
refCentroids= [geom.Pos3d(0,lower, lower), geom.Pos3d(0,upper,lower), geom.Pos3d(0,lower, upper), geom.Pos3d(0,upper, upper)]
