# -*- coding: utf-8 -*-
'''Polygon2D test. Polygon intersection verification test.'''
...
# x,y= getXYVertices(plg4)
# plt.plot(x, y, 'tab:green')
# x,y= getXYVertices(plg5)
# plt.plot(x, y, 'tab:blue')
# plt.show()
