...
centroidAB= mass_properties.get_center_of_mass_2d([(1.0, polA), (-1.0, polB)])
...
centroidL_addition= mass_properties.get_center_of_mass_2d([(1.0, sq1), (1.0, sq2), (1.0, sq4)])
centroidL_substraction= mass_properties.get_center_of_mass_2d([(1.0, polB), (-1.0, sq3)])

# Check results.
err= (centroidAB.x)**2+(centroidAB.y)**2
err+= centroidL_addition.dist2(centroidL_substraction)
err= math.sqrt(err)

# print(centroidAB)
# print(centroidL_addition)
# print(centroidL_substraction)
# print(err)
