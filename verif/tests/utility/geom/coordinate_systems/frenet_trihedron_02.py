...
pth= geom.Polyline3d([geom.Pos3d(0,0,0), geom.Pos3d(0,1,0), geom.Pos3d(0,1,1)])

ft= geom.FrenetTrihedron(pth)

halfSqrt2= math.sqrt(2)/2.0
t0= ft.getTangent(0.0)
t0Ref= geom.Vector3d(0, halfSqrt2, -halfSqrt2)
t1= ft.getTangent(1.0)
t1Ref= geom.Vector3d(0, halfSqrt2, halfSqrt2)
t2= ft.getTangent(2.0)
t2Ref= geom.Vector3d(0, -halfSqrt2, halfSqrt2)

n0= ft.getNormal(0.0)
n0Ref= geom.Vector3d(0, halfSqrt2, halfSqrt2)
n1= ft.getNormal(1.0)
n1Ref= geom.Vector3d(0, -halfSqrt2, halfSqrt2)
n2= ft.getNormal(2.0)
n2Ref= geom.Vector3d(0, -halfSqrt2, -halfSqrt2)

bRef= geom.Vector3d(1, 0, 0)
