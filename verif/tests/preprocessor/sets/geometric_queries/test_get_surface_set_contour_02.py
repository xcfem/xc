...
''' Home made test.
    Obtaining the contour of a surface set. '''
...
p5= modelSpace.newKPoint(2,1,0)
p6= modelSpace.newKPoint(2,2,0)
p7= modelSpace.newKPoint(1,2,0)

# Surfaces definition
a= modelSpace.newQuadSurface(p1, p2, p3, p4)
b= modelSpace.newQuadSurface(p3, p5, p6, p7)
...
refPointSequenceTags= [p1.tag, p2.tag, p3.tag, p5.tag, p6.tag, p7.tag, p3.tag, p4.tag]
...
print("lentgh= ",length)
print("ratio1= ",ratio1)
print('pointSequenceTags= ', pointSequenceTags)
print('refPointSequenceTags= ', refPointSequenceTags)
