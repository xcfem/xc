# -*- coding: utf-8 -*-
''' Check getOrientation method applied to nodes.'''
...
memb1= typical_materials.defElasticMembranePlateSection(preprocessor, "memb1",E= 2.1e9, nu= 0.3, rho= 0.0,h= 0.2)
modelSpace.setDefaultMaterial(memb1)
modelSpace.newSeedElement('ShellMITC4')

xcTotalSet= modelSpace.getTotalSet()
xcTotalSet.genMesh(xc.meshDir.I)

orientation= xcTotalSet.nodes.getOrientation(0.0)
