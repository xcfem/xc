# -*- coding: utf-8 -*-
''' Check the setIOrientation method. Home made test'''
...
testVector1= geom.Vector3d(1,1.1,0)
testVector2= geom.Vector3d(-1,0.9,0)
testVector3= geom.Vector3d(1,-1.1,0)

s1.setIOrientation(testVector1)
iVector1= s1.getIVector
s1.setIOrientation(testVector2)
iVector2= s1.getIVector
s1.setIOrientation(testVector3)
