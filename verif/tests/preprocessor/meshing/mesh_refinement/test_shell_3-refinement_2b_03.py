# -*- coding: utf-8 -*-
''' Test 3-refinement algorithm as defined in: «Algorithms for Quadrilateral and Hexahedral Mesh Generation» Robert Schneiders. Shell elements. Test connectivity template number 2b.
...
nNodesOK= (nNodes==4*18)
nElementsOK= (nElements==4*11)
