# -*- coding: utf-8 -*-
''' Test 3-refinement algorithm as defined in: «Algorithms for Quadrilateral and Hexahedral Mesh Generation» Robert Schneiders. Shell elements. Test connectivity template number 3.
...
n3.setProp("subdivisionLevel",2) # mark diagonal and corner nodes.
