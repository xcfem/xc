...
class ArrowOpen(ArrowHead):
    def __init__(self,lineColor):
        super(ArrowOpen,self).__init__(style= 'open', lineColor= lineColor)
...
class ArrowSolidBase(ArrowHead):
    def __init__(self,lineColor,fillColor):
        super(ArrowSolidBase,self).__init__(style= 'solid',lineColor= lineColor)
        self.fillColor= fillColor


class ArrowSolid(ArrowSolidBase):
    def __init__(self,lineColor,fillColor):
        super(ArrowSolid,self).__init__(lineColor= lineColor, fillColor= fillColor)
...
class ArrowDiamond(ArrowSolidBase):
    ...
    def __init__(self,lineColor,fillColor):
        super(ArrowDiamond,self).__init__(lineColor= lineColor, fillColor= fillColor)
...
class ArrowCircle(ArrowSolidBase):
    ...
    def __init__(self,lineColor,fillColor):
        super(ArrowCircle,self).__init__(lineColor= lineColor, fillColor= fillColor)
