...
def define_halfspaces_3planes(alpha1, beta1, alpha2, beta2, alpha3, beta3, p):
...
def define_halfspaces_3planes(alpha1, beta1, alpha2, beta2, alpha3, beta3, alpha4, beta4, p):
    P1= computeDipPlane(alpha1,beta1,p)
    P2= computeDipPlane(alpha2,beta2,p)
    P3= computeDipPlane(alpha3,beta3,p)
