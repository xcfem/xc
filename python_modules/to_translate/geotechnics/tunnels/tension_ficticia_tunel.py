...
def calcNumeroEstab(sigma0,sigmaC):
    ''' Devuelve el valor del número de estabilidad a partir de:
      ...
      :param sigma0: Tensión geostática.
      :param sigmaC: Resistencia a compresión del macizo.
...
ptosLambda0= ptosLambda0(geom.Pos2d(0,0.265), geom.Pos2d(1,0.265), geom.Pos2d(3,0.58))
...
ptosNumeroEstab= ptosNumeroEstab(geom.Pos2d(1,1), geom.Pos2d(1.125,1.5), geom.Pos2d(1.45,2), geom.Pos2d(1.75,2.5), geom.Pos2d(2.15,3) )
...
def calcPlastificationRadius(r,N):
    ''' Return the plastification radius from the values of:
        ...
        :param r: radius of the excavation
        :param N: Número de estabilidad.'''
...
def calcLambda0(r,rp):
    ''' Devuelve el valor de lambda0 (parámetro que introduce el efecto del grado de plastificación del frente) a partir de:
      ...
      :param r: radius of the excavation
      :param rp: plastification radius.'''
...
def calcM(x,r,rp):
    ''' Return the value of m (parameter that depends on the effect of the 
        ...
        :param x: distance to the excavation front.
        :param r: radius of the excavation.
        :param rp: radius of plastification.'''
    mNeq1= 1-exp(-x/0.7*r)
...
def sigmaRPanetGuenot(sigma0,x,r,rp):
    ''' Devuelve el módulo de la presión radial ficticia
        ...
        :param sigma0: Tensión inicial geostática.
        :param x: distance to the excavation front.
        :param r: radius of the excavation.
        :param rp: radius of plastification.'''
