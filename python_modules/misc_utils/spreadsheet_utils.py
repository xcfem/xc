...
def read_shapes_from_spreadsheet(namePrefix, columnOrder, columnUnits, spreadsheetFileName, E= 210000e6, nu= 0.3, post_processing_function= None):
    ...
    wb_obj= openpyxl.load_workbook(spreadsheetFileName)
