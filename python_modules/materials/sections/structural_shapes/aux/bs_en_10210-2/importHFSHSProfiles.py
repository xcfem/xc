...
columnOrder= ['','','','nmb', 'b', 'e', 'CheckAvailability', 'P', 'A', 'c_t', 'Iz', 'iz', 'Wzel', 'Wzpl', 'It', 'Wt', 'AL', 'AG']
numColumns= len(columnOrder)


columnUnits= {'b':'e-3','h':'e-3', 'e':'e-3', 'A':'e-4', 'Iz':'e-8', 'iz':'e-2', 'Wzel':'e-6', 'Wzpl':'e-6', 'Iy':'e-8', 'iy':'e-2', 'Wyel':'e-6', 'Wypl':'e-6', 'It':'e-8',  'Wt':'e-6'}
