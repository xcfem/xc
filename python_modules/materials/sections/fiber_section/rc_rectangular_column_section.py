...
class RCRectangularColumnSection(basic_rectangular_rc_section.BasicRectangularRCSection):
    ...
    def defSectionGeometry(self, preprocessor, matDiagType, twoDimensional= False):
        ...
        self.reinforcementInf= reinforcement.newStraightReinfLayer(self.fiberSectionParameters.getReinforcementDiagName())
        ...
        self.reinforcementSup= reinforcement.newStraightReinfLayer(self.fiberSectionParameters.getReinforcementDiagName())
        ...
        self.reinforcementCIzq= reinforcement.newStraightReinfLayer(self.fiberSectionParameters.getReinforcementDiagName())
        ...
        self.reinforcementCDer= reinforcement.newStraightReinfLayer(self.fiberSectionParameters.getReinforcementDiagName())
