        ...
        for element in bearingElements:
            ...
            if(eTag in sigma_perm_results):
                ...
                if(sigma_perm_cf>cf): # Update worst-case for the element.
                    ...
                    sigma_perm_results[eTag]= {'sigma_perm_cf':sigma_perm_cf, 'sigma_perm':sigma_perm, 'Fzd':Fzd, 'vxd':vxd, 'vyd':vyd, 'bearing_type':bearingType, 'x': centroid.x, 'y':centroid.y, 'z':centroid.z}
            ...
            if(eTag in sliding_perm_results):
                ...
                if(sliding_perm_cf>cf):
                    ...
                    sliding_perm_results[eTag]= {'sliding_perm_cf':sliding_perm_cf, 'friction_coef':friction_coef, 'friction_force':friction_force, 'Fxd':Fxd, 'Fyd':Fyd, 'Fzd':Fzd, 'vxd':vxd, 'vyd':vyd, 'bearing_type':bearingType, 'x': centroid.x, 'y':centroid.y, 'z':centroid.z}
            else: # no data for this element yet.
                friction_coef= bearingMat.getFrictionCoefficient(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                friction_force= bearingMat.getFrictionForce(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                sliding_perm_results[eTag]= {'sliding_perm_cf':sliding_perm_cf, 'friction_coef':friction_coef, 'friction_force':friction_force, 'Fxd':Fxd, 'Fyd':Fyd, 'Fzd':Fzd, 'vxd':vxd, 'vyd':vyd, 'bearing_type':bearingType, 'x': centroid.x, 'y':centroid.y, 'z':centroid.z}
        ...
        for element in bearingElements:
            ...
            if(eTag in sliding_var_results):
                ...
                if(sliding_cf>cf): # Update worst-case for the element.
                    friction_coef= bearingMat.getFrictionCoefficient(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                    friction_force= bearingMat.getFrictionForce(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                    sliding_var_results[eTag]= {'sliding_cf':sliding_cf, 'friction_coef':friction_coef, 'friction_force':friction_force, 'Fxd':Fxd, 'Fyd':Fyd, 'Fzd':Fzd, 'vxd':vxd, 'vyd':vyd, 'bearing_type':bearingType, 'x': centroid.x, 'y':centroid.y, 'z':centroid.z}
            else: # no data for this element yet.
                friction_coef= bearingMat.getFrictionCoefficient(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                friction_force= bearingMat.getFrictionForce(vxd= vxd, vyd= vyd, Fzd_min= Fzd, concreteBedding= True)
                sliding_var_results[eTag]= {'sliding_cf':sliding_cf, 'friction_coef':friction_coef, 'friction_force':friction_force, 'Fxd':Fxd, 'Fyd':Fyd, 'Fzd':Fzd, 'vxd':vxd, 'vyd':vyd, 'bearing_type':bearingType, 'x': centroid.x, 'y':centroid.y, 'z':centroid.z}
