...
class SectionInfo(object):
  ...
  def writeReport(self,archTex, pathFigura):
    ...
    fileHandler.write('Concrete: '+self.scc.concrType.materialName+' & Modulus of elasticity: $E_c= '+'{0:.2f}'.format(self.EHorm/1e9)+'\\ GPa$\\\\\n')
    fileHandler.write('\\hline\n')
    fileHandler.write('Steel: '+self.scc.reinfSteelType.materialName+' & Modulus of elasticity: $E_s= '+'{0:.2f}'.format(self.EAcero/1e9)+'\\ GPa$\\\\\n')
    fileHandler.write('\\end{tabular} \\\\\n')
    fileHandler.write('\\hline\n')
