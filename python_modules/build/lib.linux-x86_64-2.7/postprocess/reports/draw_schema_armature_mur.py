...
lines.append('            \\node[align=center] at (52.5117340804,20.4984820615) {\\scriptsize Armature extérieure en attente};\n')

lines.append('            \\node[align=center] at (121.347726731,163.346595998) {\\scriptsize 2};\n')
lines.append('            \\node[align=center,rotate= 93.8117523216] at (115.451952958,149.951952951) {\\scriptsize Armature extérieure voile};\n')

lines.append('            \\node[align=center] at (178.85738297,120.072670821) {\\scriptsize 3};\n')
lines.append('            \\node[align=center] at (153.634598007,114.273420575) {\\scriptsize Armature supérieure semelle};\n')

lines.append('            \\node[align=center] at (49.577122033,121.820772683) {\\scriptsize 4};\n')
lines.append('            \\node[align=center,rotate= 90.0] at (43.6580181681,121.637535593) {\\scriptsize Armature intérieure en attente};\n')

lines.append('            \\node[align=center] at (80.8112888853,164.094505215) {\\scriptsize 5};\n')
lines.append('            \\node[align=center,rotate= 90.0] at (74.8921850204,143.911268125) {\\scriptsize Armature intérieure voile};\n')

lines.append('            \\node[align=center] at (112.752598884,240.485528924) {\\scriptsize 6};\n')
lines.append('            \\node[align=center] at (119.593654573,227.760174784) {\\scriptsize Armature couronnement};\n')

lines.append('            \\node[align=center] at (117.38239102,56.06684562) {\\scriptsize 7};\n')
lines.append('            \\node[align=center] at (101.089169463,49.6237488043) {\\scriptsize Armature inférieure semelle};\n')

lines.append('            \\node[align=center] at (156.154483435,65.4035591023) {\\scriptsize 8};\n')
lines.append('            \\node[align=center] at (188.160107662,65.1388289508) {\\scriptsize Armature long. inférieure semelle};\n')

lines.append('            \\node[align=center] at (156.154483435,93.6033013945) {\\scriptsize 9};\n')
lines.append('            \\node[align=center] at (188.160107662,93.338571243) {\\scriptsize Armature long. supérieure semelle};\n')

lines.append('            \\node[align=center] at (56.0,80.6279321629) {\\scriptsize 10};\n')
lines.append('            \\node[align=center] at (30.0095613646,80.3632020114) {\\scriptsize Armature de peau semelle};\n')
lines.append('            \\node[align=center] at (36.8195348972,77.5871634597) {\\scriptsize (si nécessaire)};\n')

lines.append('            \\node[align=center] at (122.036258436,191.096444933) {\\scriptsize 11};\n')
lines.append('            \\node[align=center] at (153.077256075,190.831714782) {\\scriptsize Armature long. extérieure voile};\n')

lines.append('            \\node[align=center] at (72.1400989936,191.096444933) {\\scriptsize 12};\n')
lines.append('            \\node[align=center] at (40.7952132241,190.831714782) {\\scriptsize Armature long. intérieure voile};\n')

lines.append('            \\node[align=center] at (89.5575518254,229.612529284) {\\scriptsize 13};\n')
lines.append('            \\node[align=center] at (57.6013089556,230.640404171) {\\scriptsize Armature de peau couronnement};\n')
lines.append('            \\node[align=center] at (70.4706946023,227.985466673) {\\scriptsize (si nécessaire)};\n')

lines.append('            \\node[align=center] at (167.5,80.6279321629) {\\scriptsize 10};\n')
lines.append('            \\node[align=center] at (141.455549938,80.3632020114) {\\scriptsize Armature de peau semelle};\n')
lines.append('            \\node[align=center] at (148.265523471,77.5871634597) {\\scriptsize (si nécessaire)};\n')
