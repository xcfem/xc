...
'''
Devuelve el valor de fcv (resistencia virtual a cortante del hormigón)
   para piezas CON Ó SIN armadura de cortante, según el artículos 44.2.3.2.1 y  44.2.3.2.2 de EHE.

fact: Factor que toma el valor 0.12 para piezas SIN armadura de cortante y 0.10 para piezas CON
...
Devuelve el valor de Vu2 (cortante de agotamiento por tracción en el alma)
   para piezas SIN armadura de cortante, según el artículo 44.2.3.2.1 de EHE.
fck: Resistencia característica del hormigón a compresión.
Nd: Axil de cálculo (positivo si es de tracción).
Ac: Area total de la sección de hormigón.
b0: Anchura neta mínima del elemento a comprobar, definida de acuerdo con el artículo 40.3.5.
...
'''
Devuelve el valor de Vu2 para piezas CON o SIN armadura de cortante, según el artículo 44.2.3.2.2 de EHE.
fck: Resistencia característica del hormigón a compresión.
Nd: Axil de cálculo (positivo si es de tracción).
Ac: Area total de la sección de hormigón.
b0: Anchura neta mínima del elemento a comprobar, definida de acuerdo con el artículo 40.3.5.
...
'''
Devuelve el valor de Vu= max(Vu1,Vu2) para piezas CON o SIN armadura de cortante, según el artículo 44.2.3.2.2 de EHE.
fck: Resistencia característica del hormigón a compresión.
Nd: Axil de cálculo (positivo si es de tracción).
Ac: Area total de la sección de hormigón.
b0: Anchura neta mínima del elemento a comprobar, definida de acuerdo con el artículo 40.3.5.
