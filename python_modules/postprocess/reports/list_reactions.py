...
def listNodeReactions(preprocessor,nmbComb,nodeListArranque, fmt, fName, encab, tit, inclInertia= False):
...
def listPointReactions(nmbComb,pointList, fmt, fName, encab, tit, inclInertia= False):
  '''
...
def listPointReactionsCSV(preprocessor,nmbComb,pointList, fmt, fName, inclInertia= False):
  '''
