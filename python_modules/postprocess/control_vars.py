...
class BiaxialBucklingControlVars(BiaxialBendingControlVars):
    ...
    :ivar CFncr: Axial load divided by the critical axial load.
    :ivar strongAxisBucklingPercent: dot product (projection) of the buckling eigenvector over the strong axis.
    '''
    def __init__(self,idSection= 'nil',combName= 'nil',CF= -1.0,N= 0.0,My= 0.0,Mz= 0.0, Leff= -1.0, mechLambda= -1.0, efY= 0.0, efZ= 0.0, mode= None, CFncr= None, strongAxisBucklingPercent= 0.0):
        '''
        Constructor.
        ...
        :param CFncr: Axial load divided by the critical axial load.
        ...
        self.setBucklingParameters(Leff= Leff, mechLambda= mechLambda, efZ= efZ, efY= efY, mode= mode, CFncr= CFncr, strongAxisBucklingPercent= strongAxisBucklingPercent)

    def setBucklingParameters(self, Leff, mechLambda, efZ, efY, mode, CFncr, strongAxisBucklingPercent):
    ...
    def getDict(self):
        ...
        retval.update({'Leff': self.Leff, 'mechLambda': self.mechLambda, 'efY': self.efY, 'efZ': self.efZ, 'mode': self.mode, 'CFncr': self.CFncr, 'strongAxisBucklingPercent':self.strongAxisBucklingPercent})
        return retval
    ...
    def setFromDict(self,dct):
        ...
        self.CFncr= dct['CFncr'] # axial load divided by the critical axial load.
