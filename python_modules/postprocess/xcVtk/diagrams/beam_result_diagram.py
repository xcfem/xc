...
class BeamResultDiagram(cvd.ControlVarDiagram):
    ...
    def __init__(self, scaleFactor, lRefModSize, fUnitConv, sets, attributeName, component, defaultDirection= 'J', rgMinMax= None):
        ...
        '''
        super(BeamResultDiagram,self).__init__(scaleFactor= scaleFactor, fUnitConv= fUnitConv, sets= sets, attributeName= attributeName, component= component, defaultDirection= defaultDirection, rgMinMax= rgMinMax, lRefModSize= lRefModSize)
