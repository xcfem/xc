...
class VectorFieldData(object):
    ...
    :ivar name: name to identify VTK arrays related to this object.
    :ivar scaleFactor: scale factor for the length of the vectors.
    :ivar points: VTK data structure for points.
    :ivar vectors: VTK data structure for vectors.
    :ivar vectorsName: name to identify VTK arrays related to this object 
                       vectors.
    '''
    ...
    def setupGlyph(self, fUnitConv= 1.0, symType= vtkArrowSource()):
