...
def compute_element_resisting_forces(contour, elemSet):
    ...
    elementsOnContourBorder= elemSet.pickElemsCrossing(contourSetName, contour, 0.0)
    ...
    for e in elementsOnContourBorder.elements:
        for i, n in enumerate(e.nodes):
            if(n.Out(contour, 1, 0)): # node outside the critical contour.
