...
def plotStressStrainFibSet(fiberSet,title,fileName=None,nContours=100,pointSize=50):
  ...
  if nContours in [None,0]:
    im1=ax1.scatter(lsYcoo,lsZcoo,pointSize,lsStrain)
    im2=ax2.scatter(lsYcoo,lsZcoo,pointSize,lsStress)
  else:
