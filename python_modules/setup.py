...
setup(name='XCModules',
      ...
      packages=['rough_calculations','solution', 'model','postprocess','import_export','import_export/sciaXML','postprocess/reports','postprocess/elastic_beam_3d',"actions","actions/quake","actions/earth_pressure","actions/railway_trafic","actions/snow","actions/weight","actions/wind",'materials',"materials/ehe","materials/eae","materials/fiber_section","materials/perfiles_metalicos","materials/perfiles_metalicos/aisc","materials/perfiles_metalicos/arcelor","materials/sia262","materials/sia263","materials/pernos_anclaje","materials/xLamina","materials/xBarra","import_export","misc","xcVtk","xcVtk/malla_ef","xcVtk/malla_cad"],
