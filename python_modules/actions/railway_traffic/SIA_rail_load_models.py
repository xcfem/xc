...
class LoadModel(object):
    ...
    :ivar loadModelNumber: number of the load model.
    :ivar Qk: concentrated load.
    :ivar nA: number of concentrated loads.
    :ivar dQk: distance between loads.
    :ivar qk: uniform load.
    :ivar dQq: distance between Qk and qk loads (m)
    '''
    def __init__(self, mn, Qk= 160.0e3, nA= 4, dQk=1.6, qk= 70e3, dQq= 0.8):
        ''' Constructor.

        :param mn: number of the load model.
        :param Qk: concentrated load.
        :param nA: number of concentrated loads.
        :param dQk: distance between loads.
        :param qk: uniform load.
        :param dQq: distance between Qk and qk loads (m)
        '''
    ...
    def writeData(self, l):
        ...
        print("LM ", self.loadModelNumber, " derailment model 2 qEd= ", self.trainDerailmentModel2(l)/1e3, " kN/m")
