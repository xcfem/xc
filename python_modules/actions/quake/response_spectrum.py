...
def compute_response_spectrum(accelerations, dtA, dt= None, zLst= [.05], T_min= 1e-5, T_max= 5, Fy= 1e16, alpha= .01, uresidual= 0.0, max_prev_displ= 0.0, silent= True):
    ...
    for z in zLst:    
        ...
        for T in np.arange(T_min, T_max, dT):
            ...
            sr= sdfResponse.getResponse(dtA, dT, accelerations, uresidual, max_prev_displ)
