...
\newcommand{\nmbArchCsv}[1]{{\tt nmbArchCsv} & name of the file where are to be found the shell element forces and moments to be used in the verification of the {#1}. Directory path, file name and extension must be specified. The file contains a list of the following items (see the positive directions of the forces and moments in figure \ref{shell_forces_moments}):
