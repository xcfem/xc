...
\multicolumn{2}{p{11cm}}{\color{grayText} \large{Methods}} \\
\multicolumn{2}{p{13cm}}{\color{grayLines} \rule{\linewidth}{0.25pt}} \\
\multicolumn{2}{p{13cm}}{{\tt sectionProperties.defSeccElastica3d(mdlr)}} \\
& returns an elastic section appropiate for 3D beam analysis, from the data of the section geometric properties\\
\multicolumn{2}{p{13cm}}{{\tt sectionProperties.defSeccShElastica3d(mdlr)}} \\
...
\multicolumn{2}{p{13cm}}{{\tt sectionProperties.defSeccElastica2d(mdlr)}} \\
& returns an elastic section appropiate for 2D beam analysis, from the data of the section geometric properties\\
\multicolumn{2}{p{13cm}}{{\tt sectionProperties.defSeccShElastica2d(mdlr)}} \\
...
\multicolumn{2}{p{13cm}}{\color{grayLines} \rule{\linewidth}{0.25pt}} \\
\multicolumn{2}{p{13cm}}{{\tt parametrosSeccionCircular.setupSeccCircular(nmbSeccion,r,E,nu)}} \\
& returns a circular section \\
\multicolumn{2}{p{13cm}}{{\tt parametrosSeccionCircular.defSeccCircularElastica3d(mdlr, defSecc)}}\\
& returns an elastic circular section appropiate for 3D beam analysis.\\
\multicolumn{2}{p{13cm}}{{\tt parametrosSeccionCircular.defSeccCircularShElastica3d(mdlr, defSecc)}}\\
& returns an elastic circular section appropiate for 3D beam analysis, including shear deformations.\\
\multicolumn{2}{p{13cm}}{{\tt parametrosSeccionCircular.defSeccCircularElastica2d(mdlr, defSecc)}}\\
& returns an elastic circular section appropiate for 2D beam analysis.\\
\multicolumn{2}{p{13cm}}{{\tt parametrosSeccionCircular.defSeccCircularShElastica2d(mdlr, defSecc)}}\\
